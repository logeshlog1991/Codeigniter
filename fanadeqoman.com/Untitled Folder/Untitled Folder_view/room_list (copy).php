                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
									...
									<button class="btn btn-primary" onClick="window.location='<?php echo WEB_URL;?>hotel/add_roomMager';"><?php echo 'Add Room'; ?></button>
                                </div><!-- /.box-header -->
                                                ...
                                                <td>
                                                 ...
                                                 <td>
													 <?php if($list->main_status==1){ ?> 
														<a href="<?php echo WEB_URL;?>hotel/Inactive_roomManager/<?php echo $list->room_id;?>/<?php echo $list->hotel_id;?>">Inactive</a>
													<?php }else{ ?>
														<a href="<?php echo WEB_URL;?>hotel/Active_roomManager/<?php echo $list->room_id;?>/<?php echo $list->hotel_id;?>">Active</a>
														<?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp;
														<a href="<?php echo WEB_URL;?>hotel/View_roomManager/<?php echo $list->room_id;?>/<?php echo $list->hotel_id;?>">View</a>
												</td>
                                            </tr>
											<?php 
													$i++;
