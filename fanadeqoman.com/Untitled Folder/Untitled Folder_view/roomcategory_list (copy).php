                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									<li style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);">Room List</a></li>
									<li class="active" style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="<?php echo WEB_URL;?>hotel/room_category"><?php echo 'Room Category'; ?> </a></li>
									<li style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="<?php echo WEB_URL;?>hotel/room_type"><?php echo 'Room Type'; ?> </a></li>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($category->status==1){ ?><a href="<?php echo WEB_URL;?>hotel/inactive_category/<?php echo $category->cat_id;?>">InActive</a> <?php }else{ ?><a href="<?php echo WEB_URL;?>hotel/active_category/<?php echo $category->cat_id;?>"> Active</a>  <?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp; <a href="<?php echo WEB_URL;?>hotel/edit_category/<?php echo $category->cat_id;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/delete_category/<?php echo $category->cat_id;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
                                            </tr>
											<?php 
													$i++;
													} 
