	...
	<div class="container"> 
        ...
        <div class="checkoutsteptitle"><?php echo $this->lang->line('Step'); ?> 3: <?php echo $this->lang->line('Payment_Method'); ?><a class="modify pull-right">&nbsp;</a>
            ...
            <div id="card_payment" class=" row mt20 clearfix">
               ...
               <div class="col-lg-12 mt10 text-center"><?php echo $this->lang->line('total_payment'); ?> <b class="font24 ml10"><?php $total=$details['room_cost']*$hotel_book_details['nights']; echo '$'.$total; ?></b></div>
		       </div><!-- col- right-->
            </div><!-- row end-->
			<div id="cash_payment" class=" row mt20 mb20 clearfix" style="display:none;">
					 ...
					 <div class="col-lg-9">
						<div class="col-lg-10 mt10 text-center mb20"><?php echo $this->lang->line('total_payment'); ?> <b class="font24 ml10"><?php $total=$details['room_cost']*$hotel_book_details['nights']; echo '$'.$total; ?></b></div>
