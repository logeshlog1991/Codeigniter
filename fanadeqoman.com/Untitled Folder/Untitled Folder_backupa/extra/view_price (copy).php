				 ...
				 <table class="printTable" style="margin:0px 0px 0px 190px;">
							  <tr>
							   ...
							   <tr>
									...
									<td>
										<?php 
											if(isset($rat_tac_details->hotel_room_type) && $rat_tac_details->hotel_room_type!='')
											{
												 echo $rat_tac_details->hotel_room_type; 
											} 
										?>
									</td>
							  </tr>
							   <tr>
									...
									<td>
										<?php 
											if(isset($rat_tac_details->capacity_id) && $rat_tac_details->capacity_id!='')
											{ 
												$type=$this->Hotel_Model->get_roomType($rat_tac_details->capacity_id);
							  ...
							  <tr>
									...
									<td>
										<b>
											<?php 
												echo $this->lang->line('Nights');
											?>
										:</b>
										<?php	
											if(isset($rat_tac_details->cancel_policy_nights) && $rat_tac_details->cancel_policy_nights!='')
											{
												 echo $rat_tac_details->cancel_policy_nights; 
											}
										 ?><br/>
										<b>
											<?php 
												echo $this->lang->line('Charge'); 
											?>
										:</b>
										<?php	
											if(isset($rat_tac_details->cancel_policy_percent) && $rat_tac_details->cancel_policy_percent!='')
											{ 
												echo $rat_tac_details->cancel_policy_percent.'%'; 
											}
										?>
										<b>
										<?php 
										...
										?></b>
										<?php
											if(isset($rat_tac_details->cancel_policy_charge) && $rat_tac_details->cancel_policy_charge!=''){ 
												echo $rat_tac_details->cancel_policy_charge;
											} 
										?>&nbsp;</br>
											<b>
												<?php echo $this->lang->line('Per_Night_Charge');?>
											:</b>
											&nbsp;&nbsp;<?php echo $this->lang->line('From'); ?>
											<?php 
												if(isset($rat_tac_details->cancel_policy_from) && $rat_tac_details->cancel_policy_from!='')
												{ 
													echo $rat_tac_details->cancel_policy_from; 
												}
											?>
											&nbsp;&nbsp;
											<?php 
											...
											?>
											<?php	
												if(isset($rat_tac_details->cancel_policy_to) && $rat_tac_details->cancel_policy_to!=''){ 
													echo $rat_tac_details->cancel_policy_to; 
												} 
											?>
											<br/>
