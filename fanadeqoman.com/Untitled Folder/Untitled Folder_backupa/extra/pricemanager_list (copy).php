                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo '$'; ?></td>
												<td><?php echo $price->sell_price; ?></td>
                                                ...
                                                <td><?php echo $All_markup=$gate_markup+$callcenter_markup+$mark+$price->country_markup+$price->star_markup; ?></td>
                                                <td><?php echo $All_markup/100;?></td>
