                               ...
                               <fieldset><br/><br/><br/>
								...
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo $this->lang->line('Address'); ?></label> 
								    <div class="col-xs-12 col-md-4">
										<textarea  id="Address" name="Address" style="min-height:50px; width:257px; font-size:12px;"><?php if(isset($admin_profile->address)){ echo $admin_profile->address; } ?></textarea>
									</div>
								</div>
								<div class="form-group">
