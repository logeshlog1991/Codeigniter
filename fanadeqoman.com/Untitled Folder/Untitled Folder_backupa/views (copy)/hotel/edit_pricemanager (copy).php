										 ...
										 <div id="filtering" style="coloir:#fff; width:100%; background:#f8f8f8; display:none;">
											<table width="100%" border="1" align="left" cellpadding="0" cellspacing="0" class="display tableStatic" style="text-align:left;position:relative;left:6px;">
												<tr style="background:#3c8dbc"  height="45">
													...
													<td style="border-right:solid 1px #f8d1a3; text-align:center; width:10%; padding-left:0px;"><input name="rack_price1" id="rack_price1" type="text" class="input-field"  style="height:28px; margin-top:3px; background:#F2F2F2;" size="10"/></td>
													<td style="border-right:solid 1px #f8d1a3; text-align:center; width:10%; padding-left:0px;"><input name="sell_price1" readonly id="sell_price1" type="text" class="input-field"  style="height:28px; margin-top:3px; background:#F2F2F2;" size="10"/></td>
