<?php
	//~ $i=1;
	//~ if(isset($room_count) && $room_count!=''){ 
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
									...
									<button class="btn btn-primary" onClick="window.location='<?php echo WEB_URL;?>hotel/add_room';"><?php echo $this->lang->line('Add_RoomCount'); ?></button>
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo $count->hotel_name; ?></td>
                                                <td><?php echo $count->hotel_room_type; ?></td>
                                                <td>
													<?php
														$type=$this->Hotel_Model->get_roomType($count->max_person);
														echo $type->capacity_title; 
													?>
												</td>
                                                <td><?php echo $count->no_of_rooms; ?></td>
                                                <td><a href="<?php echo WEB_URL;?>hotel/edit_roomcount/<?php echo $count->sup_inv_cate_type_id;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/delete_roomcount/<?php echo $count->sup_inv_cate_type_id;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
                                            </tr>
											<?php 
													$i++;
													} 
