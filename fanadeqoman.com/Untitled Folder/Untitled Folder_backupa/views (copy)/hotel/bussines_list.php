                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo $fun->others_name; ?></td>
                                                <td><?php if(isset($fun->status) && $fun->status!=''){ if($fun->status=='1'){ echo 'Active';}else{ echo 'InActive'; } } ?></td>
                                                <td><?php if(isset($fun->status) && $fun->status!=''){ if($fun->status=='1'){ ?><a href="<?php echo WEB_URL;?>hotel/inactive_fun/<?php echo $fun->others_id;?>">InActive</a> <?php }else{ ?><a href="<?php echo WEB_URL;?>hotel/active_fun/<?php echo $fun->others_id;?>">Active</a> <?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/edit_fun/<?php echo $fun->others_id;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/delete_fun/<?php echo $fun->others_id;?>"><?php echo $this->lang->line('Delete'); ?></a><?php } ?></td>
                                            </tr>
											<?php 
													$i++;
													} 
