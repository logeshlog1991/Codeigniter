                               ...
                               <fieldset>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-4">
										...
										?>
											<option value="<?php echo $type->h_no; ?>" <?php if(isset($hotel_details->hotel_type)&& $hotel_details->hotel_type) { if($hotel_details->hotel_type==$type->h_no){ echo 'selected="Selected"';} } ?>><?php echo $type->hotel_type; ?></option>
										<?php
												}
											}
										?>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-4">
										...
										?>
											<option value="<?php echo $country->country_id; ?>" <?php if(isset($hotel_details->country)&& $hotel_details->country) { if($hotel_details->country==$country->country_id){ echo 'selected="Selected"';} } ?> ><?php echo $country->name; ?></option>
										<?php
												}
											}
										?>
