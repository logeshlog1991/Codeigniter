        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									<li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);" data-toggle="tab"><?php echo $this->lang->line('Supplier_list'); ?></a></li>
									...
									<li style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="<?php echo WEB_URL;?>supplier/active_suppliers"><?php echo $this->lang->line('Active_Suppliers'); ?></a></li>
							</div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
                ...
                <section class="content-header">
                    <h1>
                       <?php echo $this->lang->line('Supplier_list'); ?>
                    </h1>
                    <ol class="breadcrumb">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($supplier->active!=1){ ?> <a href="<?php echo WEB_URL;?>supplier/Active_supplier/<?php echo $supplier->supplier_id;?>"><?php echo $this->lang->line('Active'); ?></a><?php }else{ ?><a href="<?php echo WEB_URL;?>supplier/Inactive_supplier/<?php echo $supplier->supplier_id;?>"><?php echo $this->lang->line('InActive'); ?></a><?php } ?>
                                                <br/><a href="<?php echo WEB_URL;?>supplier/edit_supplier/<?php echo $supplier->supplier_id;?>"><?php echo $this->lang->line('Edit'); ?></a><br/><a onclick="return confirm('Are you sure want to delete....?')" href="<?php echo WEB_URL;?>supplier/Delete_supplier/<?php echo $supplier->supplier_id;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
                                            </tr>
                                           <?php 
													$i++;} 
												} 
