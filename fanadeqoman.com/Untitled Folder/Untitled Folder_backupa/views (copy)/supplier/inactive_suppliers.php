        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									...
									<li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);"><?php echo $this->lang->line('Inactive_Suppliers'); ?></a></li>
                ...
                <section class="content-header">
                    <h1>
						<?php echo $this->lang->line('Inactive_Suppliers'); ?>
                    </h1>
                    <ol class="breadcrumb">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($supplier->active!=1){ ?> <a href="<?php echo WEB_URL;?>supplier/Active_supplier_ad/<?php echo $supplier->agent_id;?>"><?php echo $this->lang->line('Active'); ?></a><?php }else{ ?><a href="<?php echo WEB_URL;?>supplier/Inactive_supplier/<?php echo $supplier->agent_id;?>"><?php echo $this->lang->line('InActive'); ?></a><?php } ?></td>
                                            </tr>
                                           <?php 
													$i++;} 
												} 
