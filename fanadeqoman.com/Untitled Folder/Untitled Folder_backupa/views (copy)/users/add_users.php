            ...
            <aside class="right-side">
                ...
                <section class="content">
                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									<li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);"><?php echo $this->lang->line('Add_User'); ?></a></li>
                 ...
                 <div class="box box-primary">
                                <!-- form start -->
                                <form class="form-horizontal add_supplier_form" enctype="multipart/form-data" action="<?php echo WEB_URL;?>users/add_users_ad" id="formid" method="post" onsubmit="return add_users()">
                               <fieldset><br/>
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo $this->lang->line('First_Name'); ?></label>  
								  <div class="col-xs-12 col-md-4">
										<input id="supplier_name" name="supplier_name" placeholder="First Namee" class="form-control input-md" type="text" value="">
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="company_name" name="company_name" placeholder="Last Name" class="form-control input-md" type="text" value="">
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="email" name="email" placeholder="Email ID" class="form-control input-md" type="text" value="">
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="adddress" name="adddress" placeholder="Adddress" class="form-control input-md" type="text" value="">
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="state" name="state" placeholder="State" class="form-control input-md" type="text" value="">
