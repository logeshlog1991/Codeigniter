...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo Target;?>public/css/bootstrap.css">
		<link rel="stylesheet" href="<?php echo Target;?>public/css/mystyle.css">
		<link href="<?php echo Target;?>public/css/common.css" rel="stylesheet" media="screen" id="color">
		<!-- Font Icon -->
		<link href="<?php echo Target;?>public/css/font-awesome.min.css" rel="stylesheet" media="screen">
	</head>
	<body>
		<div class="container">
		...
		<div class="container">
			<div class="row mt10">       
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<!-- thank u -->
					<div class="well">
						<div class="col-lg-1  col-xs-2 bluebg bdradius3" ><img width="50" src="<?php echo Target;?>public/img/Goth Bow.gif"></div>
			...
			<div class="col-lg-12 col-xs-12">
				...
				<div class="well">
					...
					<?php }else{ ?>
						<div class="col-lg-offset-4 col-lg-4 well graybg font18 text-center" ><span style="color:#555">Cancellation Charges:&nbsp;</span><b class="orange">$<?php echo  $book_info->markup+$book_info->callcenter_markup; ?></b></div>
	...
	<!-- footer end-->
	 ...
	 <!-- script goes down-->
	<script type="text/javascript" src="<?php echo Target;?>public/js/jquery.js"></script>
    <script type="text/javascript" src="<?php echo Target;?>public/js/jssor.core.js"></script>
    <script type="text/javascript" src="<?php echo Target;?>public/js/jssor.utils.js"></script>
    <script type="text/javascript" src="<?php echo Target;?>public/js/jssor.slider.js"></script>
	<script type="text/javascript" src="<?php echo Target;?>public/js/custom.js"></script>
