                 ...
                 <div class="box box-primary">
                               ...
                               <fieldset><br/><br/>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <select id="room_category" name="room_category" placeholder="Hotel Name" class="form-control input-md">
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										    ...
										    <select id="room_type" name="room_type" placeholder="Hotel Name" class="form-control input-md">
											  <option value=""> -Select Room Type - </option>
												<?php 
													if(isset($room_type) && $room_type!=''){
														foreach($room_type as $value){
												?>
												<option value="<?php echo $value->type_id;?>"><?php echo $value->roomtype_name;?> </option>
												<?php 
														}
													}
												?>
