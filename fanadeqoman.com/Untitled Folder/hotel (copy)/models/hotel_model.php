	...
	*/
	...
	function book_hotel($details)
	{
		...
		if($i==$j){
			...
			$rateAftergateway=($details['gate_way']/100)*($details['base_price']*$k);
			$rateAftergateway1=$rateAftergateway+($details['base_price']*$k);
				
			$admarkup=($details['admin_markup']/100)*$rateAftergateway1;
			$admarkup1=$rateAftergateway1+$admarkup;
				
			$country_markup=($details['country_markup']/100)*$admarkup1;
		...
		$data = array(
				...
				'room_baseprice'	 =>	$details['base_price'],
