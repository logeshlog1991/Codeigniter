				...
				<div class="row info">
                  ...
                  <div class="col-sm-2 mt15">
					  <form id="formid" action="<?php echo WEB_URL;?>hotel/pre_booking" method="post">
						  ...
						  <input type="hidden" name="admin_markup" id="admin_markup" value="<?php echo $adminmark; ?>" />
						  <input type="hidden" name="gate_way" id="gate_way" value="<?php echo $gate; ?>" />
						  <input type="hidden" name="country_markup" id="country_markup" value="<?php echo $tax->country_markup; ?>" />
						  <input type="hidden" name="base_price" id="base_price" value="<?php echo $rate; ?>" />
