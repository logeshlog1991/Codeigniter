		...
		<div class="container">
			...
			<div class="col-lg-12 col-xs-12">
				...
				<div class="well">
					...
					<?php }else{ ?>
						<div class="col-lg-offset-4 col-lg-4 well graybg font18 text-center" ><span style="color:#555">Cancellation Charges:&nbsp;</span><b class="orange">$<?php $total=$book_info->markup+$book_info->gateway; echo $total; ?></b></div>
