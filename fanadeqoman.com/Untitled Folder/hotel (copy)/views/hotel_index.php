			...
			<div class="col-lg-6 col-xs-12 mb20" style="background-color:#00b0f0; border-radius:3px;">
				...
				<div class=" col-lg-9 col-xs-12 mt10">
					<div class="input-group">
							...
							<input type="text" class="form-control border-right" placeholder="City" name="searchid" id="searchid" value="">
					</div>
					...
					<div class="well pad8 hotel-block">
						...
						<h6>
							...
							<span class="hotelrate">
								<?php 				
										$rate_info=$this->Hotel_Model->get_rate($latest_hotels[$i]->sup_rate_tactics_id);													
										$rate=$rate_info->rate+$rate_info->supplementary_charge_rate; 
										...
										$tax=$this->Hotel_Model->get_tax($latest_hotels[$i]->city_country_name);
										
										$final_rate=($tax!='')?($tax->country_markup/100)*$admarkup+$admarkup:0; 
					...
					<h6>
						...
						<span class="hotelrate">
							<?php 					
								...
								$rate3=$rate+$admarkup+$markup; 
								$payment_gateway=$this->Hotel_Model->payment_gateway();	
								$gateway_mrkup=$payment_gateway/100*$rate3;
								$final_rate=$rate2+$markup+$gateway_mrkup;    
								echo '$'.round($final_rate); 
							?>
						</span>
						<span class="durationinfo">R.O/night</span>
