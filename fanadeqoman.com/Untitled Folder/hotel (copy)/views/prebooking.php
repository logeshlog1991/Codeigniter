						...
						<div class="checkoutstep">
							<div class="row">
								<form class="form-horizontal form-custom" id="formid" action="<?php echo WEB_URL;?>hotel/payment_Process" method="post">
								  ...
								  <input type="hidden" id="admin_markup" name="admin_markup" value="<?php echo $details['admin_markup']; ?>" />
								  <input type="hidden" id="gate_way" name="gate_way" value="<?php echo $details['gate_way']; ?>" />
								  <input type="hidden" id="country_markup" name="country_markup" value="<?php echo $details['country_markup']; ?>" />
								   <input type="hidden" name="base_price" id="base_price" value="<?php echo $details['base_price']; ?>" />
