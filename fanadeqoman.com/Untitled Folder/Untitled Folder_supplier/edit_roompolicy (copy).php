                               ...
                               <fieldset><br/><br/>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										...
										Cost:<input type="text" id="check_in_extra_cost" name="check_in_extra_cost" size="8" value="<?php if(isset($room_policy->checkin_extracost1) && $room_policy->checkin_extracost1!=''){ echo $room_policy->checkin_extracost1;}?>" />
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										...
										Cost:<input type="text" id="check_out_extra_cost" name="check_out_extra_cost" size="8" value="<?php if(isset($room_policy->checkout_extracost1) && $room_policy->checkout_extracost1!=''){ echo $room_policy->checkout_extracost1;}?>" />
