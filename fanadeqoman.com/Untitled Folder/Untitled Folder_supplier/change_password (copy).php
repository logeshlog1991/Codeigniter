                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									<li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;">Change Password</li>
							</div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
                 ...
                 <div class="box box-primary">
                               ...
                               <fieldset><br/><br/><br/>
								...
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput">Current Password</label>  
								...
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput">New Password</label>  
								  <div class="col-xs-12 col-md-4">
								...
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput">Confirm Password</label>  
								  <div class="col-xs-12 col-md-4">
