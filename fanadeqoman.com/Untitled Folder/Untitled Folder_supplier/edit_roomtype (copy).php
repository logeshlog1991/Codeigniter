                               ...
                               <fieldset><br/><br/>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									   ...
									   <div class="input-group custom-input-group">
											<input id="room_typeA" name="room_typeA" placeholder=" Room Type" class="form-control input-md" type="text" value="<?php if(isset($roomtypeA->capacity_title) && $roomtypeA->capacity_title!=''){ echo $roomtypeA->capacity_title; } ?>"><span class="input-group-addon">Arabic</span>
										</div><br/>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										...
										<div class="input-group custom-input-group">
											<input id="adult_capacityA" name="adult_capacityA" placeholder="Adult Capacity" class="form-control input-md" type="text" value="<?php if(isset($roomtypeA->capacity) && $roomtypeA->capacity!=''){ echo $roomtypeA->capacity; } ?>"><span class="input-group-addon">Arabic</span>
										</div><br/>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
									   ...
									   <div class="input-group custom-input-group">
										<input id="child_capacityA" name="child_capacityA" placeholder="Child Capacity" class="form-control input-md" type="text" value="<?php if(isset($roomtypeA->child_capacity) && $roomtypeA->child_capacity!=''){ echo $roomtypeA->child_capacity; } ?>"><span class="input-group-addon">Arabic</span>
									</div><br/>
								  </div>
								</div>
								<div class="form-group">
