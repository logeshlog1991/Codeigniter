											...
											<tr>
												...
												<td>
													<div class="input-group custom-input-group">
														<input type="text" class="form-control" name="add_roomfac_name" id="add_roomfac_name" placeholder="Add Facilites" required><span class="input-group-addon">English</span>
													</div><br/>
													<div class="input-group custom-input-group">
														<input type="text" class="form-control" name="add_roomfac_nameA" id="add_roomfac_nameA" placeholder="Add Facilites" required><span class="input-group-addon">Arabic</span>
													</div>
												</td>
												<td> 
