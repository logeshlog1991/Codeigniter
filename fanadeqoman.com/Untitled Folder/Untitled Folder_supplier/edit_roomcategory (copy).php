								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
									   ...
									   <div class="input-group custom-input-group">
										<input id="room_categoryA" name="room_categoryA" placeholder="Room Category" class="form-control input-md" type="text" value="<?php if(isset($categoryA->hotel_room_type) && $categoryA->hotel_room_type!=''){ echo $categoryA->hotel_room_type; } ?>"><span class="input-group-addon">Arabic</span>
									   </div><br/>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									   <div class="input-group custom-input-group">
									     ...
									     <div class="input-group custom-input-group">
											<textarea id="room_descA" name="room_descA" placeholder="Room Description" class="form-control input-md" type="text"><?php if(isset($categoryA->room_desc) && $categoryA->room_desc!=''){ echo $categoryA->room_desc; } ?></textarea><span class="input-group-addon">Arabic</span>
										 </div><br/>
								  </div>
								</div>
								<div class="form-group">
