...
class Hotel extends CI_Controller {
	...
	*/
	...
	function delete_roomManager()
	{
		...
		$sup_apart_houserules_id=$this->uri->segment(6);
		$room_type_id=$this->uri->segment(7);
		$data['res']=$this->Hotel_Model->delete_room($sup_hotel_room_type_id,$hotel_id,$sup_inv_cate_type_id,$sup_apart_houserules_id,$room_type_id);
		redirect('hotel/room_list','refresh'); 
	}
