...
class Hotel_Model extends CI_Model {
	...
	*/
	public function edit_room_type_details($category,$hotel_id)
	{
	 ...
	 public function delete_room($sup_hotel_room_type_id,$hotel_id,$sup_inv_cate_type_id,$sup_apart_houserules_id,$capacity_id)
	 {
		$sql="SELECT * FROM sup_hotel_capacity WHERE hotel_id='".$hotel_id."'";
		$res=$this->db->query($sql);
		
		if($res->num_rows()>1){
			$sql="Delete from sup_hotel_capacity where capacity_id='".$capacity_id."'";
			$res=$this->db->query($sql);
			
			$sql1="Delete from sup_inv_cate_type where sup_inv_cate_type_id='".$sup_inv_cate_type_id."'";
			$res1=$this->db->query($sql1);
		}else{
			$sql="Delete from sup_hotel_capacity where capacity_id='".$capacity_id."'";
			$res=$this->db->query($sql);
			...
			$sql2="Delete from sup_apart_houserules where sup_apart_houserules_id='".$sup_apart_houserules_id."'";
			$res2=$this->db->query($sql2);
			
			$sql3="Delete from sup_hotel_room_type where sup_hotel_room_type_id='".$sup_hotel_room_type_id."'";
