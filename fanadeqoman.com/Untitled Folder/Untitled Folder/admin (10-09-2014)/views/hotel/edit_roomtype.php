                 ...
                 <div class="box box-primary">
                               ...
                               <fieldset><br/><br/>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="room_type" name="room_type" placeholder=" Room Type" class="form-control input-md" type="text" value="<?php if(isset($roomtype->capacity_title) && $roomtype->capacity_title!=''){ echo $roomtype->capacity_title; } ?>">
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="adult_capacity" name="adult_capacity" placeholder="Adult Capacity" class="form-control input-md" type="text" value="<?php if(isset($roomtype->capacity) && $roomtype->capacity!=''){ echo $roomtype->capacity; } ?>">
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="child_capacity" name="child_capacity" placeholder="Child Capacity" class="form-control input-md" type="text" value="<?php if(isset($roomtype->child_capacity) && $roomtype->child_capacity!=''){ echo $roomtype->child_capacity; } ?>">
