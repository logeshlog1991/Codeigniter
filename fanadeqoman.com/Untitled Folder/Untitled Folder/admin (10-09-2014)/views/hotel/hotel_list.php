                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <button class="btn btn-primary" onClick="window.location='<?php echo WEB_URL;?>hotel/add_hotel';"><?php echo $this->lang->line('Add_Hotel'); ?></button>
                                </div><!-- /.box-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($hotel->status!=1){ ?> <a href="<?php echo WEB_URL;?>hotel/Active_hotel/<?php echo $hotel->sup_hotel_id;?>"><?php echo $this->lang->line('Active'); ?></a><?php }else{ ?><a href="<?php echo WEB_URL;?>hotel/Inactive_hotel/<?php echo $hotel->sup_hotel_id;?>"><?php echo $this->lang->line('InActive'); ?></a><?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/edit_hotel/<?php echo $hotel->sup_hotel_id;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/delete_hotel/<?php echo $hotel->sup_hotel_id;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
                                            </tr>
											<?php 
													$i++;
													} 
