											...
											<?php $i=1;
												if(isset($room_category) && $room_category!=''){ 
													foreach($room_category as $category) {
														$arr=unserialize($category->hotel_room_services);
											 ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo $category->hotel_name; ?></td>
                                                <td><?php echo $category->hotel_room_type; ?></td>
                                                <td><?php if(count($arr)>0){$data='';foreach($arr as $value1){ $data.=$value1.",";} echo rtrim($data,','); }?></td>
                                                <td><a href="<?php echo WEB_URL;?>hotel/edit_category/<?php echo $category->sup_hotel_room_type_id;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/delete_category/<?php echo $category->sup_hotel_room_type_id;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
                                            </tr>
											<?php 
													$i++;
													} 
