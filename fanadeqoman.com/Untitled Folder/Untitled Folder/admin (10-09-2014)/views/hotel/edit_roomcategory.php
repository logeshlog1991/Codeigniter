                 ...
                 <div class="box box-primary">
                               ...
                               <fieldset><br/><br/>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="room_category" name="room_category" placeholder="Room Category" class="form-control input-md" type="text" value="<?php if(isset($category->hotel_room_type) && $category->hotel_room_type!=''){ echo $category->hotel_room_type; } ?>" onblur="check_roomcategory1()">
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<textarea id="room_desc" name="room_desc" placeholder="Room Description" class="form-control input-md" type="text"><?php if(isset($category->room_desc) && $category->room_desc!=''){ echo $category->room_desc; } ?></textarea>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-4">
										...
										?>
										<input type="checkbox" id="service[]" name="service[]" value="<?php echo $value->facility_name;?>" <?php if(count($result)>0){ foreach($result as $val){ if($value->facility_name==$val){ echo 'checked="checked"';} } } ?> >&nbsp;&nbsp;<?php echo $value->facility_name;?><br/>
										<?php 
												}
											}
										?>
