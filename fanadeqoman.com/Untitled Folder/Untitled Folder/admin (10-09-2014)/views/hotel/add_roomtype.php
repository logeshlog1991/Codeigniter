                 ...
                 <div class="box box-primary">
                               ...
                               <fieldset><br/><br/>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="room_type" name="room_type" placeholder=" Room Type" class="form-control input-md" type="text">
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="adult_capacity" name="adult_capacity" placeholder="Adult Capacity" class="form-control input-md" type="text">
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="child_capacity" name="child_capacity" placeholder="Child Capacity" class="form-control input-md" type="text">
