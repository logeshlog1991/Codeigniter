                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
									<div class="box-body table-responsive"><a style="margin:0px 0px 0px 229px;color:green;" href="<?php echo WEB_URL; ?>hotel/download"><?php echo $this->lang->line('Download'); ?></a>&nbsp;&nbsp;
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="CheckIn"><?php echo $this->lang->line('CheckIn'); ?></th>
                                                 <th class="CheckIn"><?php echo 'Check-Out';//echo $this->lang->line('CheckOut'); ?></th>
												<th class="fname"><?php echo $this->lang->line('First_Name'); ?></th>
                                                <th class="lname"><?php echo $this->lang->line('Last_Name'); ?></th>
                                                 <th class="purchase"><?php echo 'User_type'; ?></th>
                                        ...
                                        <tbody>
											...
											?>
												<tr>
													...
													<th ><?php if($details->status==1) { ?><a onclick="return confirm('Are you sure want to cancel this booking..?');" href="<?php echo WEB_URL; ?>hotel/print_cancelVoucher/<?php echo $details->hotel_id; ?>/<?php echo $details->sup_ratetacktics_id; ?>/<?php echo $details->booking_id; ?>"><?php echo "<p style='color:#3C8DBC'>Cancel</p>";?><?php }else{ echo "<p style='color:red'>Cancelled</p>";} ?></a></th>
													<th style="background-color:#D3FEFA"   class="admin-table-colo-tab vocher">
														...
														<!--<a href="<?php echo WEB_URL; ?>index/send_by_mail/<?php echo $details->hotel_id; ?>"><?php if($type!='Failed') echo "Mail";?></a>-->
													</th>
													<!--<th style="background-color:#D3FEFA"   class="admin-table-colo-tab invoice">
														<a  href="javascript:void(0);" onclick="JavaScript:newPopup('<?php echo WEB_URL; ?>index/print_invoice/<?php echo $details->booking_id; ?>');" ><?php if($type!='Failed') echo "Invoice";?></a>
														<a href="<?php echo WEB_URL; ?>index/send_by_mail/<?php echo $details->hotel_id; ?>/in"><?php if($type!='Failed') echo "Mail";?></a>
													</th>-->
													<th class="hotelname"><?php echo $details->hotel_name; ?></th>
													<!--<th class="city1"><?php //echo $details->customer_city; ?></th>-->
														<?php
															//$a = explode("-",$details->room_type);
														?>
													<!--<th class="rooms"><?php //echo $details->no_of_room; ?></th>
													<th class="roomtype"><?php //echo $a[0]; ?></th>
													<th class="basis"><?php //echo $a[1]; ?></th>-->
													<th class="status"><?php if($details->status==1) { echo "Confirmed"; } else { echo "<span style=color:red;>Cancelled</span>"; } ?></th>
													<th class="currency"><?php //echo $details->req_currency;
																				echo '$'; ?></th>
