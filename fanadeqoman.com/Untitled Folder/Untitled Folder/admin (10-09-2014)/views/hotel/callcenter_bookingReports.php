                                        ...
                                        <tbody>
											...
											?>
												<tr>
													...
													<th ><?php if($details->status==1) { ?><a onclick="return confirm('Are you sure want to cancel this booking..?');" href="<?php echo WEB_URL; ?>hotel/callcenter_cancelVoucher/<?php echo $details->hotel_id; ?>/<?php echo $details->sup_ratetacktics_id; ?>/<?php echo $details->booking_id; ?>"><?php echo "<p style='color:#3C8DBC'>Cancel</p>";?><?php }else{ echo "<p style='color:red'>Cancelled</p>";} ?></a></th>
