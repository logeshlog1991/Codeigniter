                 ...
                 <div class="box box-primary">
                               ...
                               <fieldset><br/><br/>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<input id="room_category" name="room_category" placeholder="Room Category" class="form-control input-md" type="text" onblur="check_roomcategory()"> 
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<textarea id="room_desc" name="room_desc" placeholder="Room Description" class="form-control input-md" type="text"></textarea>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-4">
										...
										?>
										<input type="checkbox" id="service[]" name="service[]" value="<?php echo $value->facility_name;?>">&nbsp;&nbsp;<?php echo $value->facility_name;?><br/>
										<?php 
												}
											}
										?>
