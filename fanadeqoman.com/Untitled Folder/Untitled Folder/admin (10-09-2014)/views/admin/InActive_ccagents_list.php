                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									...
									<li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="<?php echo WEB_URL;?>index/InActive_ccagents_list"> <?php echo $this->lang->line('InActive_CallCenter_Agents'); ?> </a></li>
											...
											<table id="example1" class="table table-bordered table-striped">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php if($value->status!=1){ ?> <a href="<?php echo WEB_URL;?>index/CCActive_callcenter_markups/<?php echo $value->callcenter_agent_id; ?>"><?php echo $this->lang->line('Active'); ?></a><?php }else{ ?><a href="<?php echo WEB_URL;?>index/CCInActive_callcenter_markups/<?php echo $value->callcenter_agent_id; ?>"><?php echo $this->lang->line('InActive'); ?></a><?php } ?></td>
													</tr>
													<?php 
															$i++;
															}
