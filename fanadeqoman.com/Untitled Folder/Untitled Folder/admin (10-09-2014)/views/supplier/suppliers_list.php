                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($supplier->active!=1){ ?> <a href="<?php echo WEB_URL;?>supplier/Active_supplier/<?php echo $supplier->agent_id;?>"><?php echo $this->lang->line('Active'); ?></a><?php }else{ ?><a href="<?php echo WEB_URL;?>supplier/Inactive_supplier/<?php echo $supplier->agent_id;?>"><?php echo $this->lang->line('InActive'); ?></a><?php } ?>
                                                <br/><a href="<?php echo WEB_URL;?>supplier/edit_supplier/<?php echo $supplier->agent_id;?>"><?php echo $this->lang->line('Edit'); ?></a><br/><a onclick="return confirm('Are you sure want to delete....?')" href="<?php echo WEB_URL;?>supplier/Delete_supplier/<?php echo $supplier->agent_id;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
                                            </tr>
                                           <?php 
													$i++;} 
												} 
