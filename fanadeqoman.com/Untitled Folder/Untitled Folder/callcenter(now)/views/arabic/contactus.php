			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<form class="form-horizontal contactform"  method="post">
				  <fieldset>
					...
					<div class="control-group">
					  <label for="contact" class="control-label"><?php echo $this->lang->line('Contact'); ?></label>
					  <div class="controls">
					...
					<div class="form-actions">
					  <input class="btn btn-blue" type="submit" value="<?php echo $this->lang->line('Submit'); ?>" id="submit_id" onclick="return dovalidation()">
					  <input class="btn" type="reset" value="<?php echo $this->lang->line('Reset'); ?>">
					</div>
				  </fieldset>
				</form>
			  </div>     
			...
			var numbers = /^[0-9]+$/;  
				...
				if($("#email12").val()!='' && $("#contact12").val()!=''){ 
					$.ajax({
						...
						.done(function( msg ){ 
							if(msg==1){
								alert('يتم إرسال رسالتك بنجاح. وسوف نعود لكم قريبا');		
