                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12   pull-right">
						...
						<!-- tabs-->
						  <div class="row clearfix">
							  <ul id="myTab1"  class="nav nav-tabs noborder" style="margin-top:0px !important">
									<li class="col-lg-4  mb0"><a class="noborder def pull-right" href="#viewrates1"><i class="icon-eye-open"></i>View All Rooms & Rates</a> </li>
									<li class="col-lg-3  mb0"><a class="noborder def pull-right" href="#hotelfacilities1"><i class="icon-smile"></i> Hotel Facilities</a> </li>
									<li class="col-lg-3  mb0"><a class="noborder def pull-right" href="#map1"><i class="icon-map-marker"></i> Location Map</a> </li>
									<li class="col-lg-2  mb0"><a class="noborder def text-right" href="#photos1" ><i class="icon-picture"></i> Photos</a> </li>
							  </ul>
						  <div class="tab-content noborder dispn" id="tab2" style=" border-top:1px dashed lightgray !important">
									 <!-- photos-->          
									 <div class="tab-pane" id="photos1">
										<div class="pull-left"> 
										...
										<div class="imgthumbs">
											<div class="col-lg-3 "><img class="photothumb" src="<?php echo WEB_DIR;?>public/img/rooms12.jpg"></div>
											<div class="col-lg-3 "><img class="photothumb" src="<?php echo WEB_DIR;?>public/img/rooms13.jpg"></div>
											<div class="col-lg-3 "><img class="photothumb" src="<?php echo WEB_DIR;?>public/img/rooms14.jpg"></div>
											<div class="col-lg-3 "><img class="photothumb"  src="<?php echo WEB_DIR;?>public/img/rate3.jpg"></div>
										</div>
									 </div>
									<!-- photos end--> 
									<!-- map-->
									<div class="tab-pane" id="map1">
										 <div class="pull-left"> <a><i class="icon-remove-sign pull-right font24 gray"></i></a> </div>
										 <div class="col-lg-offset-2 col-lg-8 grayborder mh250">map comes here</div>
									</div>
									<!-- map end--> 
									<!-- hotelfacilities-->
									<div class="tab-pane" id="hotelfacilities1">
										 <div class="pull-left"> <a><i class="icon-remove-sign pull-right font24 gray"></i></a> </div>
										 <div style="padding:30px;">
											 <div class="col-lg-4 text-right"><p><i class="icon-paper-clip ml10"></i>Kitchen - Pantry</p><p><i class="icon-paper-clip ml10"></i>Shaded Parking</p><p><i class="icon-paper-clip ml10"></i>Business Centre</p><p><i class="icon-paper-clip ml10"></i>Spa</p><p><i class="icon-paper-clip ml10"></i>Gym</p><p><i class="icon-paper-clip ml10"></i>Restaurant</p><p><i class="icon-paper-clip ml10"></i>Indoor pool</p></div>
											 <div class="col-lg-4 text-right"><p><i class="icon-paper-clip ml10"></i>Kitchen - Pantry</p><p><i class="icon-paper-clip ml10"></i>Shaded Parking</p><p><i class="icon-paper-clip ml10"></i>Business Centre</p><p><i class="icon-paper-clip ml10"></i>Spa</p><p><i class="icon-paper-clip ml10"></i>Gym</p><p><i class="icon-paper-clip ml10"></i>Restaurant</p><p><i class="icon-paper-clip ml10"></i>Indoor pool</p></div>
											 <div class="col-lg-4 text-right"><p><i class="icon-paper-clip ml10"></i>Kitchen - Pantry111111</p><p><i class="icon-paper-clip ml10"></i>Shaded Parking</p><p><i class="icon-paper-clip ml10"></i>Business Centre</p><p><i class="icon-paper-clip ml10"></i>Spa</p><p><i class="icon-paper-clip ml10"></i>Gym</p><p><i class="icon-paper-clip ml10"></i>Restaurant</p><p><i class="icon-paper-clip ml10"></i>Indoor pool</p></div>
										 </div>
									</div>
									<!-- hotelfacilities end--> 
									<!-- viewrates-->
									<div class="tab-pane" id="viewrates1">
									<div class="pull-left"> <a><i class="icon-remove-sign pull-right font24 gray"></i></a> </div>
									<div class="col-sm-12 ">
										  <table class="table table-hover grayborder">
											...
											<tbody>
											  <tr>
												<td>Standard<br><a data-toggle="modal" href="#myModal1"><h6>Room Details</h6></a></td>
												<td><i class="icon-male"></i><i class="icon-male"></i></td>
												<td>Wi-fi, Breakfast</td>
												<td>Available</td>
												<td><i class="icon-dollar"></i>1599<br><a data-toggle="modal" href="#myModal"><h6>Cancellation Policy</h6></a></td>
											  </tr>
											</tbody>
										  </table>
									</div>
	...
	<script>
	 $(document).ready(function(){
	   ...
	   $("#myTab1 > li").click(function(){
		  $("#tab2").addClass("disp");
		  $("#tab2").removeClass("dispn");
	   });
	   $(".icon-remove-sign").click(function(){
			$("#tab2").removeClass("disp");
		  $("#tab2").addClass("dispn");
	   });
	});
	//Tab Why Us
