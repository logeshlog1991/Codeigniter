<?
$latest_hotels=$this->Hotel_Model->get_latest_hotels();
?>
<!DOCTYPE html>
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo WEB_DIR;?>public/css/commonA.css">
	...
	<form method="POST" name="search" id="search" action="<?php echo site_url();?>/hotel/results" onsubmit="return formValidation()">
		<!-- find u r hotel-->
		<div class="col-lg-6 col-xs-12" style="background-color:#00b0f0;">
		<h3 class="foheading"><?php echo $this->lang->line('find_hotel'); ?></h3>
		<div class="dotborder"></div>
			<div class="col-lg-3 dest mt10"><span class="destlabel"><?php echo $this->lang->line('Destination'); ?></span></div>
				<div class=" col-lg-9 col-xs-12 mt10">
					<div class="input-group">
						...
						<input type="text" id="searchid1" name="searchid1" class="form-control border-left" placeholder="<?php echo $this->lang->line('City'); ?>">
						<input type="hidden" id="searchid" name="searchid" value="">
					</div>
				</div>
				<div class="col-lg-4 col-xs-12 mt10 ">
					<div class="checkin1"><?php echo $this->lang->line('Check-In'); ?></div>
						<div class="input-group">
							<input type="text" id="datepicker" name="checkin" class="form-control border-right" value="" placeholder="DD/MM/YY" >
							<span class="input-group-addon no-border-right border-left"><i class="icon-calendar"></i></span>
						</div>
					</div>
					<div class="col-lg-4 col-xs-12 mt10 pull-right">
					<div class="checkin1"><?php echo $this->lang->line('Check-Out'); ?></div>
						<div class="input-group">
							<input type="text" id="datepicker1" name="checkout" class="form-control border-right" value="" placeholder="DD/MM/YY" >
							<span class="input-group-addon no-border-right border-left"><i class="icon-calendar"></i></span>
						</div>
					</div>
					<div id="AC">
						<div class="col-lg-3 col-xs-6 pull-left mt10">
							<div class="checkin1"><?php echo $this->lang->line('Children'); ?></div>
							<select class="col-lg-12 col-xs-8" data-width="108px" name="child[]" id="child">
						...
						<div class="col-lg-3 col-xs-6 pull-left mt10">
							  <div class="checkin1"><?php echo $this->lang->line('Guests'); ?></div>
							  <select class="col-lg-12 col-xs-8" data-width="108px" name="adult[]" id="adult">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
							  </select>
						...
						<div class="pull-left col-xs-6 col-lg-3 mt10">
							<div class="checkin1"><?php echo $this->lang->line('Rooms'); ?></div>
							  <select class="col-lg-12 col-xs-8" data-width="108px" id="room" name="room" onchange="RoomChangeA()" >
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
							  </select>
							</div>
							<div class="col-lg-3 mt10 pull-left mb20 clear">
						...
						<div class="col-lg-6 col-xs-12">
								<div id="slider2_container" style="position: relative; top: 0px; left: 0px; width: 600px; height: 358px; overflow: hidden; ">
									<!-- Slides Container -->
									<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 358px; overflow: hidden;">
										<div>
											<img u="image" src="<?php echo WEB_DIR;?>public/img/hotel.jpg"/>
										</div>
										<div>
								   ...
								   <div u="navigator" class="jssorb05" style="position: absolute; bottom: 16px; right: 6px;">
									...
									<!-- Arrow Left -->
									<span u="arrowleft" class="jssora12l" style="width: 30px; height: 46px; top: 160px; left: 0px;"></span>
									<!-- Arrow Right -->
									<span u="arrowright" class="jssora12r" style="width: 30px; height: 46px; top: 160px; right: 0px"></span>
					...
					<div class="container">
						...
						<?php $latest_hotels=$this->Hotel_Model->get_latest_hotels();
							...
							<div class="well pad8 hotel-block">
								...
								<h5 class="text-center hotelhead" ><?php echo $latest_hotels[$i]->hotel_nameA; ?></h5>
								<h6 class="text-center hoteladdr"><?php echo $this->Hotel_Model->get_Area($latest_hotels[$i]->hotel_area).', '.$this->Hotel_Model->get_City($latest_hotels[$i]->city).', '.$this->Hotel_Model->get_Country($latest_hotels[$i]->country); ?></h6>
								<h6>
			...
			<a href="<?php echo WEB_URL;?>hotel/hotel_details/<?php echo $latest_hotels[$i]->sup_hotel_id;?>/<?php echo $latest_hotels[$i]->sup_rate_tactics_id ?>"><div class="col-lg-3">
				<div class="well pad8">
					<img style="height:160px !important;width:250px !important;" src="<?php echo WEB_DIR;?>public/hotel_img/<?php echo $latest_hotels[$i]->main_image; ?>">
					<h5 class="text-center hotelhead" ><?php echo $latest_hotels[$i]->hotel_nameA; ?></h5>
					<h6 class="text-center hoteladdr"><?php echo $this->Hotel_Model->get_Area($latest_hotels[$i]->hotel_area).', '.$this->Hotel_Model->get_City($latest_hotels[$i]->city).', '.$latest_hotels[$i]->country_name; ?></h6>
					<h6>
						<span class="pad5"><?php for($j=0;$j<$latest_hotels[$i]->star;$j++) { ?>
							<i class="icon-star"></i>
							<?php }  if($j<5) {
		...
		<?php  }
					...
					<div class="container">
						<h3 class="foheading1 pull-right"><?php echo $this->lang->line('Popular_Destinations_in_Oman'); ?></h3>
						<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1140px;
							...
							<!-- Slides Container -->
							<div u="slides" style="cursor: move; position: absolute; right: 300px; top: 0px; width: 840px; height: 480px; overflow: hidden;">
								<div>
							...
							<div u="thumbnavigator" class="jssort02" style="position: absolute; width: 300px; height: 480px; right:0px; bottom: 0px;">
