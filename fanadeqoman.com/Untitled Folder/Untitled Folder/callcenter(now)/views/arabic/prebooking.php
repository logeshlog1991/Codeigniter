							...
							<div class="checkoutstep">
							  <div class="cart-info pw100">
								<table class="table table-striped table-bordered">
								 ...
								 <tr>
								    <td class="image">
										<a ><img src="img/rate3.jpg" width="50" height="30"></a><div><?php if(isset($details['room_name'])){ echo $details['room_name'];} ?></div>
									</td>
									<td class="check_in">
          ...
          <div id="payment"></div>
           <div id="card_payment" class=" row mt20 clearfix">
             ...
             <div class="col-lg-9">
				 ...
				 <div class="col-lg-12 mt10 text-center"><?php echo $this->lang->line('total_payment'); ?> <b class="font24 ml10">$ <?php echo $total; ?> </b></div>
		    </div><!-- col- right-->
           </div><!-- row end-->
			<div id="cash_payment" class=" row mt20 mb20 clearfix" style="display:none;">
				<div class="col-lg-3 text-center"><img width="80" src="<?php echo WEB_DIR;?>public/img/hand132.png"></div><!-- col- left-->
					<div class="col-lg-9">
						<div class="col-lg-10 mt10 text-center mb20"><?php echo $this->lang->line('total_payment'); ?> <b class="font24 ml10">$ <?php echo $total; ?></b></div>
						<textarea placeholder=" Write Your Comments" cols="3"></textarea>
					</div><!-- col- right-->
				</div><!-- row end-->
				<div class="pull-left clearfix ml15"> <a class="btn btn-blue " onClick="payment_Allow()"><?php echo $this->lang->line('Pay_Securely'); ?></a></div>
			</div><!-- co step-->
          </div><!-- co title-->
      <!-- Sidebar Start-->
     </div>
