...
class Hotel extends CI_Controller {
	...
	*/
	public function edit_hotel($hotel_id)
	{
		...
		$data['hotel_detailsA']=$this->Hotel_Model->getting_hotel_detailsA($hotel_id); 
	...
	*/
	function edit_category($category_id)
	{
        ...
        $data['categoryA']=$this->Hotel_Model->getting_room_categoryA($category_id);
	...
	*/
	function edit_roomtype($roomtype_id)
	{
		if(!$this->session->userdata('admin_logged_in'))
		{
         ...
         $data['roomtypeA'] = $this->Hotel_Model->edit_roomtypeA($roomtype_id);
	...
	*/
    ...
    function add_pricemanager_ad()
	{
		...
		$this->Hotel_Model->add_pricemanager_ad($cancel_policy_descA,$child_policyA,$market_id,$cancel_policy_desc,$board_type,$hotel_id,$room_cate,$room_type,$child_policy,$cancel_policy_nights,$cancel_policy_percent,$cancel_policy_charge,$cancel_policy_from,$cancel_policy_to,$room_avail_date_from,$room_avail_date_to,$dates,$weekday,$price,$extra_bed_price,$avail,$aadult,$achild,$child_price,$infant,$fileimage,$fileimage1,$fileimage2,$fileimage3);
	...
	function edit_pricemanager($tacktics_id)
	{
        ...
        $data['rat_tac_detailsA'] = $this->Hotel_Model->get_rate_tactics_detailsA($tacktics_id);
	...
	function edit_pricemanager_ad($tacktics_id)
	{
		...
		if($_POST){
			...
			$this->Hotel_Model->edit_pricemanager_ad($child_policyA,$cancel_policy_descA,$tacktics_id,$market_id,$cancel_policy_desc,$board_type,$hotel_id,$room_cate,$room_type,$child_policy,$cancel_policy_nights,$cancel_policy_percent,$cancel_policy_charge,$cancel_policy_from,$cancel_policy_to,$room_avail_date_from,$room_avail_date_to,$dates,$weekday,$price,$extra_bed_price,$avail,$aadult,$achild,$child_price,$infant,$fileimage,$fileimage1,$fileimage2,$fileimage3);
			redirect('hotel/price_manager');
		}
	}
	...
	function edit_amenity($amenity_id)
	{
       ...
       $data['amenity_nameA']=$this->Hotel_Model->get_amenityA($amenity_id);
