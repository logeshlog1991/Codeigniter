...
class Supplier extends CI_Controller {
	...
	function edit_supplier($sup_id)
    {
		...
		$data['resultA']=$this->Supplier_Model->edit_supplierA($sup_id);
	...
	{
		$data['result']=$this->Supplier_Model->supplier_details($this->input->post('hotel_id'));
		echo json_encode($data['result']);exit;
	}
	function supplier_detailsA()
	{
		$data['result']=$this->Supplier_Model->supplier_detailsA($this->input->post('hotel_id'));
		echo json_encode($data['result']);exit;
	}
	//~ function editsupplier_details()
	//~ {
		//~ $data['result']=$this->Supplier_Model->editsupplier_details($this->input->post('hotel'));
		//~ echo json_encode($data['result']);exit;
	//~ }
	//~ function editsupplier_detailsA()
	//~ {
		//~ $data['result']=$this->Supplier_Model->editsupplier_detailsA($this->input->post('hotel'));
		//~ echo json_encode($data['result']);exit;
	//~ }
