                 ...
                 <div class="box box-primary">
                               ...
                               <legend class="pd-lr-30-px"><?php echo $this->lang->line('Login_Information'); ?></legend>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="email" name="email" placeholder="Email ID" class="form-control input-md" type="text" value="" onblur="check_Supplier()"><span class="input-group-addon">English</span>
										<span style="color:red;" id="error_email"></span>
									  </div><br/>
									  <div class="input-group custom-input-group">
										<input id="emailA" name="emailA" placeholder="Email ID" class="form-control input-md" type="text" value=""><span class="input-group-addon">Arabic</span>
									  </div>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									   <div class="input-group custom-input-group">
										<input id="password" name="password" placeholder="Password" class="form-control input-md" type="password" value=""><span class="input-group-addon">English</span>
										<span style="color:red;" id="error_password"></span>
									   </div><br/>
									   <div class="input-group custom-input-group">
										<input id="passwordA" name="passwordA" placeholder="Password" class="form-control input-md" type="password" value=""><span class="input-group-addon">Arabic</span>
									   </div>
								  </div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									   <div class="input-group custom-input-group">
										<input id="supplier_name" name="supplier_name" placeholder="Supplier Namee" class="form-control input-md" type="text" value=""><span class="input-group-addon">English</span>
										<span style="color:red;" id="error_suppliername"></span>
									   </div><br/>
									   <div class="input-group custom-input-group">
										<input id="supplier_nameA" name="supplier_nameA" placeholder="Supplier Namee" class="form-control input-md" type="text" value=""><span class="input-group-addon">Arabic</span>
									   </div>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									   <div class="input-group custom-input-group">
											<input id="company_name" name="company_name" placeholder="Company Name" class="form-control input-md" type="text" value=""><span class="input-group-addon">English</span>
											<span style="color:red;" id="error_companyname"></span>
										</div><br/>
										<div class="input-group custom-input-group">
											<input id="company_nameA" name="company_nameA" placeholder="Company Name" class="form-control input-md" type="text" value=""><span class="input-group-addon">Arabic</span>
											<span style="color:red;" id="error_companyname"></span>
										</div>
								  </div>
								</div>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="adddress" name="adddress" placeholder="Adddress" class="form-control input-md" type="text" value=""><span class="input-group-addon">English</span>
										<span style="color:red;" id="error_adddress"></span>
									  </div><br/>
									   <div class="input-group custom-input-group">
										<input id="adddressA" name="adddressA" placeholder="Adddress" class="form-control input-md" type="text" value=""><span class="input-group-addon">Arabic</span>
									  </div>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									    <div class="input-group custom-input-group">
											<input id="city" name="city" placeholder="City" class="form-control input-md" type="text" value=""><span class="input-group-addon">English</span>
											<span style="color:red;" id="error_city"></span>
										</div><br/>
										<div class="input-group custom-input-group">
											<input id="cityA" name="cityA" placeholder="City" class="form-control input-md" type="text" value=""><span class="input-group-addon">Arabic</span>
										</div>
								  </div>
								</div>
								<div class="form-group">
