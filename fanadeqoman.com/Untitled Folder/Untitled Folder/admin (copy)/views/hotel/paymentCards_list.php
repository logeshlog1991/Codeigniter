                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if(isset($payment->status) && $payment->status!=''){ if($payment->status=='1'){ ?><a href="<?php echo WEB_URL;?>hotel/inactive_cardType/<?php echo $payment->c_no;?>">InActive</a> <?php }else{ ?><a href="<?php echo WEB_URL;?>hotel/active_cardType/<?php echo $payment->c_no;?>">Active</a> <?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/edit_cardType/<?php echo $payment->c_no;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/delete_cardType/<?php echo $payment->c_no;?>"><?php echo $this->lang->line('Delete'); ?></a><?php } ?></td>
                                            </tr>
											<?php 
													$i++;
													} 
