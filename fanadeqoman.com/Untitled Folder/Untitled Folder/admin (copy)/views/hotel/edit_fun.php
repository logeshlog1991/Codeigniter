                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
								 <ul class="nav nav-tabs">
                                    ...
                                    <li class="active" style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);"><?php echo 'Bussines List'; ?></a></li>
               	...
               	<div class="box box-primary">
								<div class="box-header" style="height:50px">
									<table style="text-align:right;position:relative;right:-872px;">
										<tr> 
											<td colspan="3" class="btn btn-primary" style="text-align:right;"><a href="<?php echo WEB_URL;?>hotel/bussines_list"><b>Back</b></a></td>
										</tr>
									</table>
								</div><!-- /.box-header -->
                               <!-- form start -->
                               <form class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>hotel/edit_fun_ed/<?php echo $hotel_paytype->others_id; ?>" id="formid" method="post">
                               <fieldset><br/><br/>
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo 'Region name'; ?></label>  
								  <div class="col-xs-12 col-md-4">
										<div class="input-group custom-input-group">
											<input id="hotel_paytype" name="hotel_paytype" required placeholder="PaymentType Name" class="form-control input-md" type="text" value="<?php if(isset($hotel_paytype->others_name) && $hotel_paytype->others_name!=''){ echo $hotel_paytype->others_name; } ?>" ><span class="input-group-addon">English</span>
										</div><br/>
										<div class="input-group custom-input-group">
											<input id="hotel_paytypeA" name="hotel_paytypeA" required placeholder="PaymentType Name" class="form-control input-md" type="text" value="<?php if(isset($hotel_paytype->others_nameA) && $hotel_paytype->others_nameA!=''){ echo $hotel_paytype->others_nameA; } ?>"><span class="input-group-addon">Arabic</span>
										</div><br/>
								  </div>
								</div>
