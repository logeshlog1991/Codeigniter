...
<html>
    ...
    <body class="skin-blue">
                 ...
                 <div class="box box-primary">
								<div class="box-header" style="height:50px">
									<table style="text-align:right;position:relative;right:-872px;">
										<tr> 
										<td colspan="3" class="btn btn-primary" style="text-align:right;"><a href="<?php echo WEB_URL;?>hotel/star_list"><b>Back</b></a></td>
										</tr>
                               ...
                               <!-- form start -->
                               <form class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>hotel/editstar_ad/<?php echo $star_details->s_no; ?>" id="formid" method="post" onsubmit="return editstar_ad()">
                               <fieldset><br/><br/>
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo 'Star Name'; ?></label>  
								  <div class="col-xs-12 col-md-4">
									   <div class="input-group custom-input-group">
											<input id="star" name="star" placeholder=" Star" class="form-control input-md" type="text" value="<?php if(isset($star_details->star) && $star_details->star!=''){ echo $star_details->star; }?>">
											 <span class="input-group-addon"></span>
											<span style="color:red;" id="error_star"></span>
										</div>
								 </div>
								</div>
								<div class="form-group">
		...
		<script>
				function editstar_ad()
				{
					if($('#star').val()=='')
					{
						$('#error_star').html('required');
						return false;
					}else{
						$('#error_star').html('');
					}
