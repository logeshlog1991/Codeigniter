            ...
            <aside class="right-side">
                ...
                <section class="content">
                 ...
                 <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <div class="box-header" style="height:50px;margin:0px 0px 0px -72px;">
                                    <form name="f2" action="<?php echo WEB_URL;?>hotel/add_accommodation" method="post">
										<table style="text-align:right;position:relative;right:-572px;">
											...
											<tr>
												...
												<td>
													<div class="input-group custom-input-group">
														<input type="text" class="form-control" name="add_acc_name" id="add_acc_name" placeholder="Add Accommodation" required><span class="input-group-addon">English</span>
													</div><br/>
													<div class="input-group custom-input-group">
														<input type="text" class="form-control" name="add_acc_nameA" id="add_acc_nameA" placeholder="<?php echo $this->lang->line('Add_Accommodation'); ?>" required><span class="input-group-addon">Arabic</span>
													</div>
												</td>
												<td> 
													<div class="box-footer">
                                ...
                                <!-- form start -->
                                <div class="box-header" style="height:50px;margin:0px 0px 0px -117px;">
                                    <form name="f2" action="<?php echo WEB_URL;?>hotel/add_other_acc" method="post">
										<table style="text-align:right;position:relative;right:-572px;">
											...
											<tr>
												<td> 
													<h4><?php echo $this->lang->line('Add_Other_Accommodation'); ?>&nbsp;&nbsp;</h4>
												</td>
												<td>
													<div class="input-group custom-input-group">
														<input type="text" class="form-control" name="add_other_acc" id="add_other_acc" placeholder="Add Other Accommodation" required><span class="input-group-addon">English</span>
													</div><br/>
													<div class="input-group custom-input-group">
														<input type="text" class="form-control" name="add_other_accA" id="add_other_accA" placeholder="<?php echo $this->lang->line('Add_Other_Accommodation'); ?>" required><span class="input-group-addon">Arabic</span>
													</div>
												</td>
												<td> 
													<div class="box-footer">
                               ...
                               <fieldset>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">									  
								    ...
								    <div class="checkbox">
									  <label for="checkboxes-0">
										  <input type="radio" id="acc_name" name="acc_name" value="<?php echo $acc->accom_id; ?>"> <?php echo $acc->accom_name; ?><br>
									  </label>
									</div>
									<?php	
											}
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									   <div class="input-group custom-input-group">
											<input id="city_name" name="city_name" placeholder="City" class="form-control input-md" type="text"><span class="input-group-addon">English</span>
											<span style="color:red;" id="error_hotelcity"></span>
											<span style="color:red;" id="error_cityname"></span>
									   </div><br/>
									   <div class="input-group custom-input-group">
											<input id="city_nameA" name="city_nameA" placeholder="<?php echo $this->lang->line('City'); ?>" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
									   </div><br/>
								  </div>
								</div>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  ...
									  <div class="input-group custom-input-group">
										<input id="first_nameA" name="first_nameA" placeholder="<?php echo $this->lang->line('First_Name'); ?>" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
									  </div>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  ...
									  <div class="input-group custom-input-group">
										<input id="last_nameA" name="last_nameA" placeholder="<?php echo $this->lang->line('Last_Name'); ?>" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
									  </div><br/>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  ...
									  <div class="input-group custom-input-group">
										<input id="emailA" name="emailA" placeholder="<?php echo $this->lang->line('Email'); ?>" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
									  </div><br/>
								 </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										...
										<span style="color:red;" id="error_mobilenumber"></span>
								   	  ...
								   	  <div class="input-group custom-input-group">
										<input id="mobile_numberA" name="mobile_numberA" placeholder="<?php echo $this->lang->line('Phone'); ?>" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
									  </div><br/>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  ...
									  <div class="input-group custom-input-group">
										<input id="faxA" name="faxA" placeholder="<?php echo $this->lang->line('Fax'); ?>" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
									  </div><br/>
								  </div>
								</div>
								<div class="form-group">
									<label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo $this->lang->line('h_loc'); ?></label>  
									<div class="col-xs-12 col-md-4">
										...
										?>
											<option value="<?php echo $location->loc_sno; ?>"><?php echo $location->location_name; ?></option>
										<?php
												}
											}
										?>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									   <div class="input-group custom-input-group">
											<textarea id="hotel_address" name="hotel_address" placeholder="Hotel Address" class="form-control input-md" type="text"></textarea><span class="input-group-addon">English</span>
											<span style="color:red;" id="error_adddress"></span>
									   </div><br/>
									   <div class="input-group custom-input-group">
											<textarea id="hotel_addressA" name="hotel_addressA" placeholder="<?php echo $this->lang->line('Hotel_Address'); ?>" class="form-control input-md" type="text"></textarea><span class="input-group-addon">Arabic</span>
									   </div><br/>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<textarea id="hotel_description" name="hotel_description" placeholder="Hotel_Description" class="form-control input-md" type="text"></textarea><span class="input-group-addon">English</span>
										<span style="color:red;" id="error_desc"></span>
									  </div><br/>
									   <div class="input-group custom-input-group">
										<textarea id="hotel_descriptionA" name="hotel_descriptionA" placeholder="<?php echo $this->lang->line('Hotel_Description'); ?>" class="form-control input-md" type="text"></textarea><span class="input-group-addon">Arabic</span>
										</span>
									  </div><br/>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									   <div class="input-group custom-input-group">
											<input id="nearby_airport" name="nearby_airport" placeholder="Nearby_Airport" class="form-control input-md" type="text"><span class="input-group-addon">English</span>
											<span style="color:red;" id="error_na"></span>
									   </div><br/>
									    <div class="input-group custom-input-group">
											<input id="nearby_airportA" name="nearby_airportA" placeholder="<?php echo $this->lang->line('Nearby_Airport'); ?>" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
										</div><br/>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="latitude" name="latitude" placeholder="Latitude" class="form-control input-md" type="text"><span class="input-group-addon">English</span>
										<span style="color:red;" id="error_lt"></span>
									  </div><br/>
									  <div class="input-group custom-input-group">
										<input id="latitudeA" name="latitudeA" placeholder="<?php echo $this->lang->line('Latitude'); ?>" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
									  </div><br/>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									   <div class="input-group custom-input-group">
											<input id="longitude" name="longitude" placeholder="Longitude" class="form-control input-md" type="text"><span class="input-group-addon">English</span>
											<span style="color:red;" id="error_lg"></span>
									   </div><br/>
									   <div class="input-group custom-input-group">
											<input id="longitudeA" name="longitudeA" placeholder="<?php echo $this->lang->line('Longitude'); ?>" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
											<span style="color:red;" id="error_lg"></span>
									   </div><br/>
								 </div>
								</div>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">									  
								    ...
								    <div class="checkbox">
									  <label for="checkboxes-0">
										  <input type="checkbox" id="amenity_name" name="amenity_name[]" value="<?php echo $amen->amenity_list_id; ?>"> <?php echo $amen->amenity_name; ?><br>
									  </label>
									</div>
									<?php	
											}
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">									  
								    ...
								    <div class="checkbox">
									  <label for="checkboxes-0">
										  <input type="checkbox" id="other_acc_name" name="other_acc_name[]" value="<?php echo $acc->others_id; ?>"> <?php echo $acc->others_name; ?><br>
									  </label>
									</div>
									<?php	
											}
