                ...
                <form class="form-horizontal add_hotel_form" action="#" id="formid" method="post" onsubmit="return add_hotel_validation()">
						 ...
						 <table class="printTable" style="margin:0px 0px 0px 190px;">
							  ...
							  <tr>
									...
									<td>
										<?php echo $hotel_cat->hotel_room_type; ?>
									</td>
							  </tr>
							  <tr>
									<th>
							  ...
							  <tr>
									...
									<td>
										<?php 
											...
											$hotel_loc=unserialize($hotel_cat->hotel_room_services);
											$total_loc='';
							  ...
							  <tr>
									...
									<td>
										<?php echo  $room_type->capacity_title; ?>
									</td>
							  </tr>
							  <tr>
									<th>
									...
									<td>
										<?php echo  $hotel_policy->arrivaltime_from; ?>
									</td>
							  </tr>
							  <tr>
									<th>
									...
									<td>
										<?php echo  $hotel_policy->departtime_before; ?>
									</td>
							  </tr>
							  <tr>
									<th>
									...
									<td>
										<?php echo  $hotel_policy->checkin_extracost1;echo '&nbsp'; echo 'Per Hour'; ?>
									</td>
							  </tr>
							  <tr>
									<th>
									...
									<td>
										<?php echo  $hotel_policy->checkout_extracost1;echo '&nbsp'; echo 'Per Hour'; ?>
									</td>
							  </tr>
							  <tr>
									<th>
									...
									<td>
										<?php echo  $hotel_policy->sp_policies; ?>
									</td>
							  </tr>
						 </table><br/>
						</form>
						...
						<div class="noprint" style="margin:0px 0px 0px 310px;">
							<table>
								  <tr>
										<a href="<?php echo WEB_URL;?>hotel/edit_category/<?php echo $category_id; ?>/<?php echo $hotel_id; ?>/<?php echo $roomtype_id; ?>/<?php echo $policy_id; ?>/<?php echo $capacity_id; ?>" class="btn btn-primary">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp; 
										<a href="<?php echo WEB_URL;?>hotel/delete_roomManager/<?php echo $rat_tac_details->sup_rate_tactics_id;?>" class="btn btn-primary">Delete</a>
								  </tr>
							</table>
						</div>
						<br/><br/><br/><br/>
