                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li style="width: 19% !important;font-size:16px;font-family:bold:helica;"><a href="<?php echo WEB_URL;?>hotel/star_list"><?php echo $this->lang->line('Amenity_List'); ?></a></li>
									<li class="active" style="width: 19% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);"><?php echo 'Stars List'; ?></a></li>
							</div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
                 </section>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($star->status==1){ echo $this->lang->line('Active'); }else{ echo $this->lang->line('InActive'); } ?></td>
                                                <td><?php if($star->status=='1'){ ?><a href="<?php echo WEB_URL;?>hotel/inactive_star/<?php echo $star->s_no;?>">InActive</a> <?php }else{ ?><a href="<?php echo WEB_URL;?>hotel/active_star/<?php echo $star->s_no;?>">Active</a> <?php } ?> &nbsp;&nbsp;/&nbsp;&nbsp; <a href="<?php echo WEB_URL;?>hotel/edit_star/<?php echo $star->s_no;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/delete_star/<?php echo $star->s_no; ?>"><?php echo $this->lang->line('Delete'); ?></a></td>
                                            </tr>
											<?php 
													$i++;
													} 
