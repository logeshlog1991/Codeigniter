            ...
            <aside class="right-side">
                ...
                <section class="content">
                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									...
									<li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);">  <?php echo $this->lang->line('Payment_Gateway'); ?></a></li>
									<li style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="<?php echo WEB_URL;?>index/markup_manager"><?php echo $this->lang->line('Markup_Management'); ?></a></li>
						      </div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
                 </section><!-- /.content -->
                 <div class="box box-primary">
                                <!-- form start -->
                                <form class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>index/update_payment_charge" id="formid" method="post" onsubmit="return update_payment_charge()">
                               <fieldset><br/><br/><br/>
								<!-- Form Name -->
								<?php 
									if(isset($id) && $id!=''){
								...
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo $this->lang->line('Amount_in'); ?> %</label>  
								  <div class="col-xs-12 col-md-4">
										<input id="currency_value" name="currency_value" placeholder="Currency Value" class="form-control input-md" type="text" value="<?php echo $this->admin_model->get_payment_charge(); ?>">
