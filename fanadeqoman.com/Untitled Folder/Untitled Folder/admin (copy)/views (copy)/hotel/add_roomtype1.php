								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									   <div class="input-group custom-input-group">
										 ...
										 <div class="input-group custom-input-group">
											<input id="adult_capacityA" name="adult_capacityA" placeholder="Adult Capacity" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
										 </div><br/>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										...
										<div class="input-group custom-input-group">
											<input id="child_capacityA" name="child_capacityA" placeholder="Child Capacity" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
										</div><br/>
									</div>
								</div>
								<div class="form-group">
