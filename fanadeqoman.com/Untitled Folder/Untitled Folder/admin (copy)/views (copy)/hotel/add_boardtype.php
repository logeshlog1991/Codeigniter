            ...
            <aside class="right-side">
                ...
                <section class="content">
                 ...
                 <div class="box box-primary">
                               ...
                               <!-- form start -->
                               <form class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>hotel/boardtype_ad" id="formid" method="post" onsubmit="return boardtype_ad()">
                               <fieldset><br/><br/>
								 <div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo 'Board Type'; ?></label>  
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="boardtype" name="boardtype" placeholder="Board Type" class="form-control input-md" type="text" onblur="check_Boardtype()" ><span class="input-group-addon">English</span>
										<span style="color:red;" id="error_boardtype"></span>
									  </div><br/>
									  <div class="input-group custom-input-group">
										<input id="boardtypeA" name="boardtypeA" placeholder="Board Type" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
