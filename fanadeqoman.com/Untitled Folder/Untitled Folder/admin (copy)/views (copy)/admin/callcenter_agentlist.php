                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									<li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);"><?php echo $this->lang->line('Call_Center_Agents'); ?></a></li>
										...
										<div class="box-body table-responsive">
											<table id="example1" class="table table-bordered table-striped">
												...
												<tbody>
													...
													<tr>
														<td><?php echo $i;?></td>
														<td><?php echo $value->callagent_id; ?></td>
														<td><?php echo $value->name; ?></td>
														<td><?php echo $value->email_id; ?></td>
														<td><?php if($value->status==1){ echo "Active";}else{ echo "InActive"; } ?></td>
														<td><?php if($value->status!=1){ ?> <a href="<?php echo WEB_URL;?>index/CCActive_callcenter_markup/<?php echo $value->callcenter_agent_id; ?>"><?php echo $this->lang->line('Active'); ?></a><?php }else{ ?><a href="<?php echo WEB_URL;?>index/CCInActive_callcenter_markup/<?php echo $value->callcenter_agent_id; ?>"><?php echo $this->lang->line('InActive'); ?></a><?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>index/edit_callcenter_markup/<?php echo $value->callcenter_agent_id;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>index/CCdelete_callcenter_markup/<?php echo $value->callcenter_agent_id;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
													</tr>
													<?php 
															$i++;
															}
