			...
			<div class="modal-dialog">
			  <div class="modal-content">
				...
				<div class="modal-body">
				  <input type="text" id="modalInputText">
				</div>
                               ...
                               <fieldset><br/><br/><br/>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<div class="input-group custom-input-group" style="margin-bottom:7px;">									  
											<input id="First_Name" name="First_Name" placeholder="First Name" class="form-control input-md" type="text" value="<?php if(isset($admin_profile->firstname)){ echo $admin_profile->firstname;}?>"><span class="input-group-addon">English</span>
										</div>
										<div class="input-group custom-input-group">	
											<input id="First_NameA" name="First_NameA" class="form-control input-md" type="text" value="<?php if(isset($admin_profileA->firstname)){ echo $admin_profileA->firstname;}?>"><span class="input-group-addon"> Arabic</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group" style="margin-bottom:7px;">	
										<input id="Last_Name" name="Last_Name" placeholder="Last Name" class="form-control input-md" type="text" value="<?php if(isset($admin_profile->lastname)){ echo $admin_profile->lastname;}?>"><span class="input-group-addon">English</span><span style="color:red;" id="error_hotelcity"></span>
									  </div>	
									  <div class="input-group custom-input-group">	
										<input id="Last_NameA" name="Last_NameA" class="form-control input-md" type="text" value="<?php if(isset($admin_profileA->lastname)){ echo $admin_profileA->lastname;}?>"><span class="input-group-addon">Arabic</span>
									  </div>
								</div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4" >
									  <div class="input-group custom-input-group" style="margin-bottom:7px;">	
										<input id="Email" name="Email" placeholder="Email" class="form-control input-md" type="text" value="<?php if(isset($admin_profile->email)){ echo $admin_profile->email;}?>"><span class="input-group-addon">English</span>
									  </div>
									  
									  <div class="input-group custom-input-group">	
										<input id="EmailA" name="EmailA" placeholder="Email" class="form-control input-md" type="text" value="<?php if(isset($admin_profileA->email)){ echo $admin_profileA->email;}?>"><span class="input-group-addon">Arabic</span>
									  </div>
								  </div>
								</div>
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo $this->lang->line('Address'); ?></label> 
								    <div class="col-xs-12 col-md-4">
										<div class="input-group custom-input-group" style="margin-bottom:7px;">	
											<textarea  id="Address" name="Address" style="min-height:50px; width:257px; font-size:12px;"><?php if(isset($admin_profile->address)){ echo $admin_profile->address; } ?></textarea><span class="input-group-addon">English</span>
										</div>
										
										<div class="input-group custom-input-group">	
											<textarea  id="AddressA" name="AddressA" style="min-height:50px; width:257px; font-size:12px;"><?php if(isset($admin_profileA->address)){ echo $admin_profileA->address; } ?></textarea><span class="input-group-addon">Arabic</span>
										</div>
								  </div>
								</div>
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo $this->lang->line('Contact_No'); ?></label> 
								       <div class="col-xs-12 col-md-4">
										  <div class="input-group custom-input-group" style="margin-bottom:7px;">	
											<input id="Contact_No" name="Contact_No" placeholder="Contact No" class="form-control input-md" type="text" value="<?php if(isset($admin_profile->contact_no)){ echo $admin_profile->contact_no;}?>"><span class="input-group-addon">English</span>
										  </div>
										   <div class="input-group custom-input-group">	
											<input id="Contact_NoA" name="Contact_NoA" placeholder="Contact No" class="form-control input-md" type="text" value="<?php if(isset($admin_profileA->contact_no)){ echo $admin_profileA->contact_no;}?>"><span class="input-group-addon">Arabic</span>
										  </div>
								      </div>
								</div>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									 ...
									 <div class="input-group custom-input-group">
										<select id="bank_countryA" name="bank_countryA" class="form-control input-md">
											<option value="">-Select Country-</option>
											<?php
												 for($iii=0;$iii<count($country);$iii++){
											?>
													<option  value="<?php  echo $country[$iii]->country_id;  ?>"  <?php if(isset($admin_profileA->city_id) && $country[$iii]->country_id == $admin_profileA->city_id){ echo "selected='selected'"; } ?>><?php  echo $country[$iii]->name;  ?></option>
											<?php }	?>
										</select>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  ...
									  <div class="input-group custom-input-group">
										<input id="postalA" name="postalA" placeholder="Postal/ Zip code" class="form-control input-md" type="text" value="<?php if(isset($admin_profileA->postal_code)){ echo $admin_profileA->postal_code;}?>">
										<span class="input-group-addon">Arabic</span>
									  </div>
								  </div>
								</div>
