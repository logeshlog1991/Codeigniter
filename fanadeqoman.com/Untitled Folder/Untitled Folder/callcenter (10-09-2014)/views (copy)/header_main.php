...
<div class="container">
		<div class="row " style=" margin:0;background:url(<?php echo WEB_DIR;?>public/img/headerbg1.jpg) repeat-x;height:35px;">
			...
			<div class="col-lg-2">	<div class="currency pull-left"><span class="mr">USD</span><span class="mr"><img style="width:16px;" src="<?php echo WEB_DIR;?>public/img/icon/dollar.PNG"></span></div>
				<div class="language pull-right"><span class="mr">Arabic</span><span class="mr"><img  src="<?php echo WEB_DIR;?>public/img/icon/globe.PNG"></span></div>
