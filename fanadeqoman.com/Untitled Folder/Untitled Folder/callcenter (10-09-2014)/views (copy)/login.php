...
<html class="bg-black">
    <head>
        ...
        <!-- bootstrap 3.0.2 -->
        <link href="<?php echo WEB_DIR;?>public/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- font Awesome -->
        <link href="<?php echo WEB_DIR;?>public/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        <link href="<?php echo WEB_DIR;?>public/css/AdminLTE.css" rel="stylesheet" type="text/css" />
