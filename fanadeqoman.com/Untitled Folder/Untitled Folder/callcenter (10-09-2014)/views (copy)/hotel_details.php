   ...
   <div class="wrapper">
		...
		<div class="container">
			...
			<div class="modifybox">
					<div class="row">
							<div class="col-lg-3">
								<div class="mofind">Update Search</div>
									<div class="input-group">
										<span class="input-group-addon"><i class=" icon-map-marker"></i></span>
										<input type="text" id="searchid" name="searchid"  class="form-control" value="<?php echo $combination['cityname'];?>" placeholder="Region , Town , Hotel Name">
									</div>
									 ...
									 <select class="mosearch" style="float:right; margin-top:40px; margin-right:18px;" name="child[]" id="child<?php echo $j; ?>" onchange="childFuns(<?php echo $j; ?>)">
									  ...
									  <div id="child_age<?php echo $j; ?>">
											...
											<div class="clearfix mt10">
											  <select name="child_age[]" id="child_age" class="mosearch" style="float:right">
              ...
              <div class="col-lg-1"><div style="float:right; margin-top:38px;" ><input type="submit" class="fobutton" value="Search"></div></div>
              </div>
		...
		<div class="container">
			<div class="well">
				<h3 class="orangetxt"><b><?php echo $hotel_info->hotel_name;?></b></h3>
					...
					<p class="font16">
						<?php echo $hotel_info->city.', '.$hotel_info->city_country_name.'.';?>
				    </p>
			</div>
		</div>
		<!-- hotel details end-->  
		<!-- slider-->
		<div class="container">
		<div class="well well-sm well-blue ">PHOTOS</div>
		<!-- Slides Container -->
		<div id="slider3_container" style="position: relative; width: 720px;height: 350px; overflow: hidden; margin-bottom:10px;">
			<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 720px; height: 350px;overflow: hidden;">
				<div>
					<img u="image" src="<?php echo WEB_DIR;?>public/hotel_img/<?php echo $hotel_tactic->main_image;?>" />
					<img u="thumb" src="<?php echo WEB_DIR;?>public/hotel_img/<?php echo $hotel_tactic->main_image;?>" />
				</div>
				<div>
					<img u="image" src="<?php echo WEB_DIR;?>public/hotel_img/<?php echo $hotel_tactic->image1;?>" />
					<img u="thumb" src="<?php echo WEB_DIR;?>public/hotel_img/<?php echo $hotel_tactic->image1;?>" />
				</div>
				<div>
					<img u="image" src="<?php echo WEB_DIR;?>public/hotel_img/<?php echo $hotel_tactic->image2;?>" />
					<img u="thumb" src="<?php echo WEB_DIR;?>public/hotel_img/<?php echo $hotel_tactic->image2;?>" />
				</div>
				<div>
					<img u="image" src="<?php echo WEB_DIR;?>public/hotel_img/<?php echo $hotel_tactic->image3;?>" />
					<img u="thumb" src="<?php echo WEB_DIR;?>public/hotel_img/<?php echo $hotel_tactic->image3;?>" />
				</div>  
			</div>
		...
		<!-- property overview-->
		<div class="container">
		   <div class="well well-sm well-blue">PROPERTY OVERVIEW</div>
		   <div class="well"><?php echo $hotel_info->descrip; ?></div>
		</div>
		<!-- property overview end-->
		<!-- property FACILITIES-->
		<div class="container">
			<div class="well well-sm well-blue">PROPERTY FACILITIES</div>
			<div class="well">
				<?php
					$var = unserialize($hotel_info->hotel_amenity);
					for($k=0;$k<count($var);$k++) { 
						echo '<i class="icon-paper-clip mr10"></i>'.$var[$k].'<br>'; 
					}
					$var1 = unserialize($hotel_info->other_accommodation);
					for($k=0;$k<count($var1);$k++) { 
						echo '<i class="icon-paper-clip mr10"></i>'.$var1[$k].'<br>'; 
					} 
				?>
			</div>
		</div>
		...
		<!-- rooms & Rates-->
		<div class="container">
		   <div class="well well-sm well-blue">ROOMS &amp; RATES</div>
		   <?php $res=$this->Hotel_Model->get_category($hotel_info->sup_hotel_id); 
					if($res!='') {
			...
			<div class="well">
				<div class="row info">
                  ...
                  <div class="col-sm-2 mt20">
					<?php  
						$var3=unserialize($cate->hotel_room_services); if($var3!='') {
                  ...
                  <div class="col-sm-4 ">
                     <div class="row">
                        ...
                        <div class="col-sm-4 col-sm-offset-2 mt10"><span class="rate"><?php 
							$tax=$this->Hotel_Model->get_tax($hotel_info->city_country_name);
							$rate=$rate->rate+$rate->supplementary_charge_rate;
							$markup=($tax!='')?$tax->country_markup/100*$rate:0; 
							$final_rate=$rate+$markup;    
                        echo $final_rate; ?></span></div>
                  ...
                  <div class="col-sm-2 mt15">
					  <form id="formid" action="<?php echo WEB_URL;?>hotel/pre_booking" method="post">
						  ...
						  <input type="hidden" id="nights" name="nights" value="<?php echo $combination['nights']; ?>" />
						  <input type="hidden" id="check_in" name="check_in" value="<?php echo $combination['checkin']; ?>" />
						  <input type="hidden" id="check_out" name="check_out" value="<?php echo $combination['checkout']; ?>" />
						  <input type="hidden" id="room" name="room" value="<?php echo $combination['rooms']; ?>" />
    ...
    <!--  rooms & Rates end-->
         ...
         <!-- property FACILITIES-->
 <div class="container">
   <div class="well well-sm well-blue">LOCATION MAP</div>
   ...
   <div class="well" id="map_canvas" style="height:400px;" >    <!-- <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d248849.84916296514!2d77.6309395!3d12.9539974!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1407913978538" width="100%" height="450" frameborder="0" style="border:0"></iframe>--></div>
    ...
    <!-- property FACILITIES end-->
     ...
     <div class="container">
		   <div class="well well-sm well-blue">PROPERTY CONTACT DETAILS</div>
			   <div class="well"> 
					<address>
					  <div class="row pad8">
						 <div class="col-sm-2"><b>Address</b></div>
						 <div class="col-sm-10">
						 <div><?php echo $hotel_info->address.',';?></div>
						 <div><?php echo $hotel_info->city.',';?></div>
						 <div><?php echo $hotel_info->city_country_name.'.';?></div>
						 </div>
					  </div>
					  <div class="row pad8">
						 <div class="col-sm-2"><b>Telephone</b></div>
						 <div class="col-sm-10"><?php echo $hotel_info->res_phone;?></div>
					  </div>
					   <div class="row pad8">
						 <div class="col-sm-2"><b>Email</b></div>
						 <div class="col-sm-10"><?php echo $hotel_info->res_email;?></div>
					  </div>
					  <div class="row pad8">
						 <div class="col-sm-2"><b>Fax</b></div>
						 <div class="col-sm-10"><?php echo $hotel_info->res_fax;?></div>
					  </div>
				   </address>
				 </div>
		   </div>
		...
		<div class="container">
			<div class="well well-sm well-blue">SIMILER PROPERTIES FOUND</div>
				<div class="row">
					<?php 
					...
					?>
						...
						<h6 class=" hoteladdr"><?php echo $hotels[$i]->address?></h6><h6 class=" hoteladdr"><?php echo $hotels[$i]->city.', '.$hotels[$i]->city_country_name.'.'; ?></h6>
						<h6>
							...
							<span class="hotelrate">
								<?php 
									$tax=$this->Hotel_Model->get_tax($hotel_info->city_country_name);
									$rate=$hotels[$i]->rate+$hotels[$i]->supplementary_charge_rate; 
									$markup=($tax!='')?($tax->country_markup/100*$rate):0;
									$final_rate=$rate+$markup;                       
									echo '$'.$final_rate;
								?>
