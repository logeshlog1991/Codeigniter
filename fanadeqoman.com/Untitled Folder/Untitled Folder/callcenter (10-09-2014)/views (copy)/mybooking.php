					  ...
					  <table class="table table-hover grayborder">
						...
						<tbody>
						  ...
						  <!--  <td><?php echo '2'; ?></td>-->
							...
							<td><?php if($result[$i]->status==1) { ?><a onclick="return confirm('Are you sure want to delete...?');" href="<?php echo WEB_URL; ?>hotel_user/cancel_booking/<?php echo $result[$i]->booking_id;?>">Cancel</a> <?php } else { echo 'Cancelled'; } ?></td>
