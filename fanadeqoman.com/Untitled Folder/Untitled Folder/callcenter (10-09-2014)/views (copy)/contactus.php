	...
	<body>
		<div class="wrapper">
				...
				<div class="container">
					...
					<div class="col-lg-8 mt30 mb20"><span class="pull-right contact">24545262</span> <span class="pull-right mt5"><img src="<?php echo WEB_DIR;?>public/img/icon/phone.png"></span></div>
				</div>
