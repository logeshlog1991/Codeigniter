		 ...
		 <?php 
		   ...
		   <div class="well">     
				<div class="row info">
				  <div class="col-sm-4">
							<!--
							//$cate=$this->Hotel_Model->get_catedetails($res[$i]->category_type); 
							//$room_type=$this->Hotel_Model->get_room_type($res[$i]->room_type); 
							-->
				  ...
				  <div class="col-sm-2">
					 <?php  
						$var3=unserialize($res[$i]->hotel_room_services); if($var3!='') {
				  ...
				  <div class="col-sm-2 mt15">
						<form id="formid<?php echo $i; ?>" action="<?php echo WEB_URL;?>hotel/pre_booking" method="post">
						  ...
						  <input type="button" class="btn btn-blue btn-small wid100 pull-right" value="<?php echo $this->lang->line('book_now'); ?>" onclick="check_avilabless('<?php echo $i; ?>')" />
						</form>
				  </div>
			   </div>
			</div>
