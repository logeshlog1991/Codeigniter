	...
	<body>
		...
		<div class="container">
			<div class="row mt10">       
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="well">
						...
						<div class="col-lg-11 col-xs-10" >
							<h3 class=" heading3 text-center" style="padding:14px; margin-bottom:0px !important;"><?php echo $this->lang->line('thank'); ?> <span class="orangetxt"><?php echo  $hotel_info->hotel_name; ?>.</span><?php echo $this->lang->line('confirm'); ?> .</h3></div>
						</div><!-- well-->
						<!-- thank u end-->
					...
					<div class="col-lg-12 ">
						<div class="well " style="background-color:#F5F5F5;box-shadow: 0px 2px 5px #878787;">
							<div class="row">
							  <div class="col-lg-6">
								<div class="col-lg-6"><h4><div class=" text-right"><?php echo $this->lang->line('reservation'); ?> :</div></h4></div>
								<div class="col-lg-6"><h4><div class=" text-left"> <?php echo $book_info->booking_id; ?></div></h4></div>
							  </div>
							  <div class="col-lg-6">
								  <div class="col-lg-6"><h4><div class=" text-right"><?php echo $this->lang->line('date_booking'); ?> :</div></h4></div>
					...
					<!-- left side-->
					  <div class="col-lg-6 clear">
						<div class="well text-center font18 bluetxt" style="background-color:#f5f5f5"><?php echo $this->lang->line('Traveller'); ?></div>
						<div class="well">
							<div class="col-lg-6 col-xs-7 text-right">
							  <h4><?php echo $this->lang->line('Guest_Name'); ?> :</h4>
							  <h4><?php echo $this->lang->line('Voucher_Date'); ?> :</h4>
							  <h4><?php echo $this->lang->line('Transaction_NO'); ?> :</h4>
							  <h4><?php echo $this->lang->line('Check-In'); ?> :</h4>
							  <h4><?php echo $this->lang->line('Check-Out'); ?> :</h4>
							  <h4><?php echo $this->lang->line('email'); ?> :</h4>
							  <h4><?php echo $this->lang->line('contact-number'); ?> :</h4>
							  <h4><?php echo $this->lang->line('Payment-Summary'); ?> :</h4>
							</div>
				...
				<div class="col-lg-6">
				<!-- hotel details-->
			   <div class="well text-center font18 bluetxt" style="background-color:#f5f5f5"><?php echo $this->lang->line('Hotel-Details'); ?></div>
				<div class="well">
					<div class="row">
						<div class="col-lg-4 col-xs-6 text-right"><h4><?php echo $this->lang->line('Hotel-Name'); ?> :</h4></div>
						<div class="col-lg-8 col-xs-6"><h4><?php echo $hotel_info->hotel_name; ?></h4></div>
					</div>
					<div class="row">
						<div class="col-lg-4  col-xs-6 text-right"><h4><?php echo $this->lang->line('Address'); ?> :</h4></div>
						<div class="col-lg-8 col-xs-6 "><h4><?php echo $this->Hotel_Model->get_hotelArea($hotel_info->hotel_area); ?>, <br><?php echo $this->Hotel_Model->get_hotelCity($hotel_info->city); ?>,<br><?php echo $this->Hotel_Model->city_country_name($hotel_info->country); ?>.</h4></div>
					</div>
					<div class="row">
						<div class="col-lg-4 col-xs-6  text-right"><h4><?php echo $this->lang->line('Contact'); ?> :</h4></div>
						<div class="col-lg-8 col-xs-6 "><h4><?php echo  $hotel_info->mobile_number; ?></h4></div>
					</div>
					<div class="row">
						<div class="col-lg-4 col-xs-6  text-right"><h4><?php echo $this->lang->line('Fax'); ?> :</h4></div>
						<div class="col-lg-8 col-xs-6 "><h4><?php echo  $hotel_info->fax; ?></h4></div>
					</div>
					<div class="row">
						<div class="col-lg-4 col-xs-6 text-right"><h4><?php echo $this->lang->line('email'); ?> :</h4></div>
			...
			<!-- cancellation policy-->
			<div class="col-lg-12">
				<div class="well  text-center font18 bluetxt" style="background-color:#f5f5f5"><?php echo $this->lang->line('Cancellation_Policy'); ?></div>
				<div class="well">
