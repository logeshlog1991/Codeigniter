		   ...
		   ?>
			<div class="well">
				<div class="row info">
                  <div class="col-sm-4">
					 <h4>
						 <?php echo $res[$i]->hotel_room_type; ?>-<?php echo $res[$i]->capacity_title; ?>
					</h4>
                   </div>
                  <div class="col-sm-2 mt20">
					<?php 
						$capacity_title=$res[$i]->hotel_room_services;
						if(isset($capacity_title) && $capacity_title!=''){
						 $var3=unserialize($capacity_title);
						 if($var3!='') {
