...
class Hotel extends CI_Controller {
	...
	{
		$data['banners'] = $this->Hotel_Model->get_banners();
		$data['popular_banners'] = $this->Hotel_Model->get_popularBanners();
		
		if($_SESSION['langH']=='english')
		{
			$this->load->view('hotel_index',$data);
		}else{
			$this->load->view('arabic/hotel_index',$data);
		}
	}
	...
	function about_us()
	{
		$data['res']=$this->Hotel_Model->get_aboutUs('About Us');
		if($_SESSION['langH']=='english')
		{
			$this->load->view('aboutus',$data);
		}else{
			$this->load->view('arabic/aboutus',$data);
		}
	}
	function contact_us()
	{
		$data['res']=$this->Hotel_Model->get_contactUs('Contact Us');
		if($_SESSION['langH']=='english')
		{
			$this->load->view('contactus',$data);
		}else{
			$this->load->view('arabic/contactus',$data);
		}
	}
	function faq()
	{
		$data['res']=$this->Hotel_Model->get_faq('Faq');
		if($_SESSION['langH']=='english')
		{
			$this->load->view('faq',$data);
		}else{
			$this->load->view('arabic/faq',$data);
		}
	}
	function terms_conditions()
	{
		
		$data['res']=$this->Hotel_Model->get_terms('Terms & Conditions');
		if($_SESSION['langH']=='english')
		{
			$this->load->view('terms_conditions',$data);
		}else{
			$this->load->view('arabic/terms_conditions',$data);
		}
	}
