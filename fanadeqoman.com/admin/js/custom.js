	...
	function check_roomcategory(){
		if($("#room_category").val()!=''){
			...
			$.ajax({
				 ...
				 type: 'post',
				 data:  {'room_category':$("#room_category").val()},
				 success: function(output) {
					 if(output==1){
	...
	function check_roomcategory1(){
		...
		if($("#room_category").val()!=''){
			...
			$.ajax({
				 ...
				 type: 'post',
				 data:  {'room_category':$("#room_category").val(),'main_category':$("#room_hiddencat").val()},
				 success: function(output) {
					 if(output==1){
						$("#error_category").html('Room Category Already Exits');
					 }else{
	...
	function check_roomtype(){
		if($("#room_category").val()!=''){
			var base_url=$("#web_url").val();
			$.ajax({
				 url: base_url+"hotel/check_roomtype",
				 type: 'post',
				 data:  {'room_category':$("#room_category").val()},
				 success: function(output) {
					 if(output==1){
						$("#error_category").html('Room Type Already Exits');
					 }else{
						$("#error_category").html('');
					 }
				}
	...
	function check_roomtype1(){
		...
		if($("#room_category").val()!=''){
			var base_url=$("#web_url").val();
			$.ajax({
				 url: base_url+"hotel/check_roomtype1",
				 type: 'post',
				 data:  {'room_category':$("#room_category").val(),'main_category':$("#room_hiddencat").val()},
				 success: function(output) {
					 if(output==1){
