...
class Hotel extends CI_Controller {
	...
	*/
	...
	function delete_roomManager()
	{
		...
		$room_id=$this->uri->segment(3);
		$hotel_id=$this->uri->segment(4);
		$data['res']=$this->Hotel_Model->delete_room($room_id,$hotel_id);
		redirect('hotel/room_list','refresh'); 
	}
	function add_roomMager()
	{
        ...
        $data['room_type']=$this->Hotel_Model->room_type_list();
	...
	*/
	...
	function add_category()
	{
        ...
        $this->load->view('hotel/add_category');
    }
	function check_roomcategory()
	{
		$data['result']=$this->Hotel_Model->check_roomcategory($this->input->post('room_category'));
		echo $data['result'];exit;
		
	}
	function check_roomcategory1()
	{
		$data['result']=$this->Hotel_Model->check_roomcategory1($this->input->post('room_category'),$this->input->post('main_category'));
		echo $data['result'];exit;
	...
	function roomcategory_ad()
	{
        ...
        $post=$this->input->post();
		$data['result']=$this->Hotel_Model->add_roomcategory($post);
	...
	function edit_category($cat_id)
	{
		if(!$this->session->userdata('admin_logged_in'))
		{
         ...
         $data['result']=$this->Hotel_Model->get_category($cat_id);
         $this->load->view('hotel/edit_category',$data);	
	}
	function edit_category_ad($cat_id)
	{
		if(!$this->session->userdata('admin_logged_in'))
		{
            redirect('index/login');
        ...
        $post=$this->input->post();
		$data['result']=$this->Hotel_Model->edit_category_ad($post,$cat_id);
		redirect('hotel/room_category','refresh'); 
	}
	function delete_category($cat_id)
	{
        ...
        $data['result']=$this->Hotel_Model->delete_category($cat_id);
        redirect('hotel/room_category','refresh'); 
	}
	function inactive_category($cat_id)
	{
        ...
        $data['result']=$this->Hotel_Model->inactive_category($cat_id);
        redirect('hotel/room_category','refresh'); 
	}
	function active_category($cat_id)
	{
        ...
        $data['result']=$this->Hotel_Model->active_category($cat_id);
        redirect('hotel/room_category','refresh'); 
	}
	...
	function add_roomType()
	{
        ...
        $this->load->view('hotel/add_roomType');
	}
	function check_roomtype()
	{
		$data['result']=$this->Hotel_Model->check_roomtype($this->input->post('room_category'));
		echo $data['result'];exit;
		
	}
	function check_roomtype1()
	{
		$data['result']=$this->Hotel_Model->check_roomtype1($this->input->post('room_category'),$this->input->post('main_category'));
		echo $data['result'];exit;
	...
	function roomtype_ad()
	{
        ...
        $post=$this->input->post();
		$data['result']=$this->Hotel_Model->add_roomtype($post);
		redirect('hotel/room_type','refresh'); 
	}
	function edit_roomtype($cat_id)
	{
		if(!$this->session->userdata('admin_logged_in'))
		{
            redirect('index/login');
        }
         $data['result']=$this->Hotel_Model->get_type1($cat_id);
         $this->load->view('hotel/edit_roomtype',$data);	
	}
	function edit_roomtype_ad($cat_id)
	{
		if(!$this->session->userdata('admin_logged_in'))
		{
            redirect('index/login');
        ...
        $post=$this->input->post();
		$data['result']=$this->Hotel_Model->edit_roomtype_ad1($post,$cat_id);
		redirect('hotel/room_type','refresh'); 
		
	}
	function inactive_roomtype($cat_id)
	{
		if(!$this->session->userdata('admin_logged_in'))
		{
            redirect('index/login');
        }
        $data['result']=$this->Hotel_Model->inactive_roomtype1($cat_id);
        redirect('hotel/room_type','refresh'); 
	}
	function active_roomtype($cat_id)
	{
		if(!$this->session->userdata('admin_logged_in'))
		{
            redirect('index/login');
        }
        $data['result']=$this->Hotel_Model->active_roomtype1($cat_id);
        redirect('hotel/room_type','refresh'); 
	}
	function delete_roomtype($cat_id)
	{
		if(!$this->session->userdata('admin_logged_in'))
		{
            redirect('index/login');
        }
        $data['result']=$this->Hotel_Model->delete_type1($cat_id);
        redirect('hotel/room_type','refresh'); 
	}
