                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <button class="btn btn-primary" onClick="window.location='<?php echo WEB_URL;?>users/add_users';"><?php echo $this->lang->line('Add_User'); ?></button>
                                </div><!-- /.box-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($users->status!=1){ ?> <a href="<?php echo WEB_URL;?>users/Active_users/<?php echo $users->prim_uid;?>"><?php echo $this->lang->line('Active'); ?></a><?php }else{ ?><a href="<?php echo WEB_URL;?>users/Inactive_users/<?php echo $users->prim_uid;?>"><?php echo $this->lang->line('InActive'); ?></a><?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>users/edit_users/<?php echo $users->prim_uid;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>users/delete_users/<?php echo $users->prim_uid;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
                                            </tr>
											<?php
													$i++;} 
												} 
