					 ...
					 <div class="row">
						...
						<div class="col-lg-2 col-md-4 col-xs-6 thumb">
							<a class="thumbnail" href="<?php echo WEB_URL;?>hotel/hotel_manager" title="Hotel Manager">
								<img height="42" width="92" class="img-responsive" src="<?php echo IMG_PATH; ?>hotel-icon.png" alt=""><center><?php echo $this->lang->line('Hotel_Manager'); ?></center>
							</a>
						</div>
						<div class="col-lg-2 col-md-4 col-xs-6 thumb">
							<a class="thumbnail" href="<?php echo WEB_URL;?>hotel/room_list" title="Room Manager">
						...
						<div class="col-lg-2 col-md-4 col-xs-6 thumb">
							<a class="thumbnail" href="<?php echo WEB_URL;?>hotel/B2C_bookingReports" title="Booking Manager">
