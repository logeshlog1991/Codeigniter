                 ...
                 <div class="box box-primary">
                               ...
                               <legend class="pd-lr-30-px"><?php echo $this->lang->line('Login_Information'); ?></legend>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										<textarea id="adddress" name="adddress" placeholder="Adddress" class="form-control input-md" type="text"><?php if(isset($result->address)){ echo $result->address; } ?></textarea>
