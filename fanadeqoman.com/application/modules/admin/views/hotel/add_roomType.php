            ...
            <aside class="right-side">
                ...
                <section class="content">
                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									<li class="active" style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);"><?php echo 'Add Room Type'; ?></a></li>
							 </div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
                 ...
                 <div class="box box-primary">
                               ...
                               <!-- form start -->
                               <form class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>hotel/roomtype_ad" id="formid" method="post">
                               <fieldset><br/><br/>
								
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo 'Room Type'; ?></label>  
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="room_category" name="room_category" placeholder="Room Type" class="form-control input-md" type="text" onblur="check_roomtype()"> <span class="input-group-addon">English</span>
										<span style="color:red;" id="error_category"></span>
									  </div><br/>
									  <div class="input-group custom-input-group">
										<input id="room_categoryA" name="room_categoryA" placeholder="Room Type" class="form-control input-md" type="text"> <span class="input-group-addon">Arabic</span>
									  </div><br/>
								  </div>
								</div>
