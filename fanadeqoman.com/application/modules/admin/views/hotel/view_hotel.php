                ...
                <form class="form-horizontal add_hotel_form" action="#" id="formid" method="post" onsubmit="return add_hotel_validation()">
							...
							<div class="form-group" >
							  <label class="col-xs-12 col-md-3 control-label" for="textinput"></label>  
								<div class="col-xs-12 col-md-4" style="margin-left: 22cm;">
									  ...
									  <a href="<?php echo WEB_URL;?>hotel/hotel_manager" class="btn btn-primary"><?php echo $this->lang->line('Back'); ?></a>
								</div>
							</div>
						 </div><!-- /.box-header -->
						 <table class="printTable"
							  ...
							  <tr>
							   ...
							   <tr>
									<th>
										<?php echo $this->lang->line('cp_name'); ?>
										&nbsp;&nbsp;
									</th>
									<td>
							    ...
							    <tr>
									<th>
										<?php echo $this->lang->line('cp_Designation'); ?>
										&nbsp;&nbsp;
									</th>
									<td>
							   ...
							   <tr>
									<th>
										<?php echo $this->lang->line('cp_Number'); ?>
										&nbsp;&nbsp;
									</th>
									<td>
							   ...
							   <tr>
									<th>
										<?php echo $this->lang->line('cp_Email'); ?>
										&nbsp;&nbsp;
									</th>
									<td>
							   ...
							   <tr>
									<th>
										<?php echo $this->lang->line('r_Email'); ?>
										&nbsp;&nbsp;
									</th>
									<td>
							  ...
							  <tr>
									<th>
										<?php echo $this->lang->line('r_Email2'); ?>
										&nbsp;&nbsp;
									</th>
									<td>
							   ...
							   <tr>
							    ...
							    <tr>
									<th>
										<?php echo $this->lang->line('r_Telephone'); ?>
										&nbsp;&nbsp;
									</th>
									<td>
							  ...
							  <tr>
							   ...
							   <tr>
									<th>
										<?php echo $this->lang->line('Hotel_Amenity'); ?>
										&nbsp;&nbsp;
									</th>
									<td>
										 <?php 
							  ...
							  <tr>
									<th>
										<?php echo $this->lang->line('m_image'); ?>
										&nbsp;&nbsp;
									</th>
									<td>
							   ...
							   <tr>
									<th>
										<?php echo $this->lang->line('Hotel_Description'); ?>
										Hotel Description&nbsp;&nbsp;
									</th>
									<td>
										<?php 
											if($_SESSION['lang']=='english'){
												echo $hotel_details->hotel_desc;
											}else{
												echo $hotel_details->hotel_descA;
											}
									   ?>
									</td>
							  </tr>
							   <tr>
									<th>
										<?php echo $this->lang->line('Hotel_Policies'); ?>
										&nbsp;&nbsp;
									</th>
									<td>
										<?php 
											if($_SESSION['lang']=='english'){
												echo $hotel_details->hotel_policy;
											}else{
												echo $hotel_details->hotel_policyA;
											}
										?>
									</td>
							  </tr>
						 ...
						 <div class="form-group noprint">
						  <label class="col-xs-12 col-md-3 control-label" for="textinput"></label>  
							<div class="col-xs-12 col-md-4">
								  <a href="<?php echo WEB_URL;?>hotel/edit_hotel/<?php echo $hotel_details->sup_hotel_id;?>" class="btn btn-primary"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;&nbsp;&nbsp; 
								  <a href="<?php echo WEB_URL;?>hotel/delete_hotel/<?php echo $hotel_details->sup_hotel_id;?>" class="btn btn-primary"><?php echo $this->lang->line('Delete'); ?></a>
							</div>
						 </div>
						 </form>
			 </aside><!-- /.right-side -->
