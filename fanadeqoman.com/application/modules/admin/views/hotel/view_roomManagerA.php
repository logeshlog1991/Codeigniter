                ...
                <form class="form-horizontal add_hotel_form" action="#" id="formid" method="post" onsubmit="return add_hotel_validation()">
							...
							<div class="form-group" >
							  <label class="col-xs-12 col-md-3 control-label" for="textinput"></label>  
								<div class="col-xs-12 col-md-4" style="margin-left: 14cm;">
									  ...
									  <a href="<?php echo WEB_URL;?>hotel/room_list" class="btn btn-primary"><?php echo $this->lang->line('Back'); ?></a>
								</div>
							</div>
						 </div><!-- /.box-header -->
						 <table class="printTable" style="margin:0px 0px 0px 190px;">
							  <tr>
									...
									<td>
										<?php echo $hotel_details->hotel_nameA; ?>
									</td>
							  </tr>
							   <tr>
									<th>
							 ...
							 <tr>
									...
									<td>
										<?php 
											echo $room_details->hotel_room_typeA; 
										?> 
									</td>
							  </tr>
							  <tr>
									...
									<td>
										<?php 
											echo $room_details->capacity_titleA; 
										?> 
									</td>
							  </tr>
							  <tr>
							  ...
							  <tr>
									...
									<td>
										<?php echo $room_details->room_descA; ?>
									</td>
							  </tr>
							  <tr>
									<th>
							  ...
							  <tr>
									<th>
										<!--Room Check-In Time-->
										غرفة الاختيار في الوقت المناسب&nbsp;&nbsp;
									</th>
									<td>
							  ...
							  <tr>
									...
									<td>
										<?php echo  $room_details->sp_policiesA; ?>
									</td>
							  </tr>
						 </table><br/>
						</form>
						...
						<div class="noprint" style="margin:0px 0px 0px 310px;">
							<table>
								  <tr>
										<a href="<?php echo WEB_URL;?>hotel/edit_roomManager/<?php echo $room_details->room_id; ?>/<?php echo $room_details->hotel_id; ?>" class="btn btn-primary"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;&nbsp;&nbsp; 
										<a href="<?php echo WEB_URL;?>hotel/delete_roomManager/<?php echo $room_details->room_id; ?>/<?php echo $room_details->hotel_id; ?>" class="btn btn-primary"><?php echo $this->lang->line('Delete'); ?></a>
								  </tr>
							</table>
						</div>
						<br/><br/><br/><br/>
