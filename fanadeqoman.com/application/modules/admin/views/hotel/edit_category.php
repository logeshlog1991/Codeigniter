            ...
            <aside class="right-side">
                ...
                <section class="content">
                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									<li class="active" style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);"><?php echo 'Edit Category'; ?></a></li>
							 </div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
                 ...
                 <div class="box box-primary">
                               ...
                               <!-- form start -->
                               <form class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>hotel/edit_category_ad/<?php echo $result->cat_id; ?>" id="formid" method="post">
                               <fieldset><br/><br/>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="room_category" name="room_category" placeholder="Room Category" class="form-control input-md" type="text" value="<?php if(isset($result) && $result!=''){ echo $result->category_name; } ?>" onblur="check_roomcategory1()"> <span class="input-group-addon">English</span>
										<span style="color:red;" id="error_category"></span>
									  </div><br/>
									  <div class="input-group custom-input-group">
										<input id="room_categoryA" name="room_categoryA" placeholder="Room Category" class="form-control input-md" type="text" value="<?php if(isset($result) && $result!=''){ echo $result->category_nameA; } ?>"> <span class="input-group-addon">Arabic</span>
									  </div><br/>
								  </div>
								</div>
								<input id="web_url" name="web_url" class="form-control input-md" type="hidden" value="<?php echo WEB_URL; ?>"> 
								<input id="room_hiddencat" name="room_hiddencat" class="form-control input-md" type="hidden" value="<?php if(isset($result) && $result!=''){ echo $result->category_name; } ?>"> 
								<div class="form-group">
