                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo $this->lang->line('City_Town'); ?></th>
                                                <th><?php echo $this->lang->line('Area'); ?></th>
                                                <th><?php echo $this->lang->line('Contract_Start'); ?></th>
                                                <th><?php echo $this->lang->line('Contract_End'); ?></th>
                                                <th><?php echo $this->lang->line('Contract_Remaining_Days'); ?></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($hotel->status==1) { echo $this->lang->line('Active'); } else { echo $this->lang->line('InActive'); } ?></td>
                                                <td>
													<a href="<?php echo WEB_URL;?>hotel/view_hotel/<?php echo $hotel->sup_hotel_id;?>"><?php echo $this->lang->line('View'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<?php if($hotel->status!=1){ ?> <a href="<?php echo WEB_URL;?>hotel/Active_hotel/<?php echo $hotel->sup_hotel_id;?>"><?php echo $this->lang->line('Active'); ?></a><?php }else{ ?><a href="<?php echo WEB_URL;?>hotel/Inactive_hotel/<?php echo $hotel->sup_hotel_id;?>"><?php echo $this->lang->line('InActive'); ?></a><?php } ?>
												</td>
                                            </tr>
											<?php 
													$i++;
