                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="#tab_1" data-toggle="tab"> <?php echo 'Board Manager'; ?></a></li>
                             </div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
                 ...
                 <div class="box box-primary">
								<div class="box-header" style="height:50px">
									<table style="text-align:right;position:relative;right:-872px;">
										<tr> 
										<td colspan="3" class="btn btn-primary" style="text-align:right;"><a href="<?php echo WEB_URL;?>hotel/boardtype_manager"><b>Back</b></a></td>
										</tr>
										
									</table>
								</div><!-- /.box-header -->
                               <!-- form start -->
                               <form class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>hotel/boardtype_edit/<?php echo $result->b_no; ?>" id="formid" method="post" onsubmit="return boardtype_ad()">
                               <fieldset><br/><br/>
								 <div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo 'Board Type'; ?></label>  
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="boardtype" name="boardtype" placeholder="Board Type" class="form-control input-md" type="text" onblur="check_Boardtype1()" value="<?php if(isset($result) && $result!=''){ echo $result->board_name; } ?>"><span class="input-group-addon">English</span>
										<span style="color:red;" id="error_boardtype"></span>
									  </div><br/>
									  <div class="input-group custom-input-group">
										<input id="boardtypeA" name="boardtypeA" placeholder="Board Type" class="form-control input-md" type="text" value="<?php if(isset($result) && $result!=''){ echo $result->board_nameA; } ?>"><span class="input-group-addon">Arabic</span>
										<span style="color:red;" id="error_boardtypeA"></span>
									  </div><br/>
								  </div>
								</div>
								<input type="hidden" id="board_main" name="board_main" value="<?php if(isset($result) && $result!=''){ echo $result->board_name; } ?>">
