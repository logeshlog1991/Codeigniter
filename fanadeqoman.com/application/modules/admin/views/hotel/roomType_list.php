                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									...
									<li style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="<?php echo WEB_URL;?>hotel/room_category"><?php echo 'Room Category'; ?> </a></li>
									<li class="active" style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="<?php echo WEB_URL;?>hotel/room_type"><?php echo 'Room Type'; ?> </a></li>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
									...
									<button class="btn btn-primary" onClick="window.location='<?php echo WEB_URL;?>hotel/add_roomType';"><?php echo 'Add Type'; ?></button>
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											<?php $i=1;
												if(isset($room_category) && $room_category!=''){ 
													foreach($room_category as $category) {
											?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo $category->roomtype_name; ?></td>
                                                <td><?php if($category->status==1){ echo 'Active'; }else{ echo 'InActive'; } ?></td>
                                                <td><?php if($category->status==1){ ?><a href="<?php echo WEB_URL;?>hotel/inactive_roomtype/<?php echo $category->type_id;?>">InActive</a> <?php }else{ ?><a href="<?php echo WEB_URL;?>hotel/active_roomtype/<?php echo $category->type_id;?>"> Active</a>  <?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp; <a href="<?php echo WEB_URL;?>hotel/edit_roomtype/<?php echo $category->type_id;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/delete_roomtype/<?php echo $category->type_id;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
                                            </tr>
											<?php 
													$i++;
													} 
