            ...
            <aside class="right-side">
                ...
                <section class="content">
               	...
               	<div class="box box-primary">
                               ...
                               <!-- form start -->
                               <form class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>hotel/edit_loc_ed/<?php echo $hotel_paytype->loc_sno; ?>" id="formid" method="post">
                               <fieldset><br/><br/>
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo 'Region name'; ?></label>  
								  <div class="col-xs-12 col-md-4">
										<div class="input-group custom-input-group">
											<input id="hotel_paytype" name="hotel_paytype" required placeholder="PaymentType Name" class="form-control input-md" type="text" value="<?php if(isset($hotel_paytype->location_name) && $hotel_paytype->location_name!=''){ echo $hotel_paytype->location_name; } ?>" ><span class="input-group-addon">English</span>
										</div><br/>
										<div class="input-group custom-input-group">
											<input id="hotel_paytypeA" name="hotel_paytypeA" required placeholder="PaymentType Name" class="form-control input-md" type="text" value="<?php if(isset($hotel_paytype->location_nameA) && $hotel_paytype->location_nameA!=''){ echo $hotel_paytype->location_nameA; } ?>"><span class="input-group-addon">Arabic</span>
										</div><br/>
								  </div>
								</div>
