                            ...
                            <div class="box">
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											<?php $i=1;
												if(isset($hotel_payment) && $hotel_payment!=''){ 
													foreach($hotel_payment as $payment) {
											 ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo $payment->payment_type; ?></td>
                                                <td><?php if(isset($payment->status) && $payment->status!=''){ if($payment->status=='1'){ echo 'Active';}else{ echo 'InActive'; } } ?></td>
                                                <td><?php if(isset($payment->status) && $payment->status!=''){ if($payment->status=='1'){ ?><a href="<?php echo WEB_URL;?>hotel/inactive_paymentType/<?php echo $payment->p_no;?>">InActive</a> <?php }else{ ?><a href="<?php echo WEB_URL;?>hotel/active_paymentType/<?php echo $payment->p_no;?>">Active</a> <?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/edit_paymentType/<?php echo $payment->p_no;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/delete_paymentType/<?php echo $payment->p_no;?>"><?php echo $this->lang->line('Delete'); ?></a><?php } ?></td>
                                            </tr>
											<?php 
													$i++;
													} 
