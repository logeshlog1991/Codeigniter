...
<html>
    ...
    <style>.width346{ width:346px;} td{ min-width:125px;}</style>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="#tab_1" data-toggle="tab">Edit Hotel</a></li>
                                    <li style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="<?php echo WEB_URL;?>hotel/edit_hotel_details/<?php echo $hotel_details->sup_hotel_id; ?>">Edit Hotel Details </a></li>
                            </div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
                    <div class="row">
                 ...
                 <div class="box box-primary">
                                ...
                                <div class="box-header" style="height:50px;">
                                    <form name="f2" method="post">
										<table style="text-align:right;position:relative;right:-150px;">
											...
											<tr>
												<td> <h4>Add Star Rating&nbsp;&nbsp;</h4></td>
												<td>
													<div class="input-group custom-input-group width346">
														<input type="text" class="form-control" name="add_starRatings_name" id="add_starRatings_name" placeholder="Add Star Ratings" required onblur="check_starRatings()"><span class="input-group-addon"></span>
													</div>
                               ...
                               <form class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>hotel/edit_hotel_ad/<?php echo $hotel_details->sup_hotel_id;?>" id="formid" method="post">
                               <fieldset>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
											<input id="hotel_name" name="hotel_name" placeholder="Hotel Name" value="<?php echo $hotel_details->hotel_name; ?>" class="form-control input-md" type="text" onblur="Hotel_Exits1()"><span class="input-group-addon">English</span>
											<input id="old_hotel_name" name="old_hotel_name" type="hidden" value="**">
											<span style="color:red;" id="error_hotelname"></span>
									  </div><br/>
									  <div class="input-group custom-input-group">
											<input id="hotel_nameA" name="hotel_nameA" placeholder="<?php echo $this->lang->line('Hotel_Name'); ?>" class="form-control input-md" type="text" value="<?php echo $hotel_details->hotel_nameA; ?>" onblur="Hotel_Exits()"><span class="input-group-addon">Arabic</span>
									  </div><br/>	
								  </div>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-4">
										...
										?>
											<option value="<?php echo $type->h_no; ?>" <?php if(isset($hotel_details->hotel_type)&& $hotel_details->hotel_type) { if($hotel_details->hotel_type==$type->h_no){ echo 'selected="Selected"';} } ?>>
												<?php 
												if($_SESSION['lang']=='english')
												{
													echo $type->hotel_type;
												}else{
													echo $type->hotel_typeA;
												}
												?>
											</option>
										<?php
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
										...
										?>
											<option value="<?php echo $star->s_no; ?>" <?php if(isset($hotel_details->star)&& $hotel_details->star) { if($hotel_details->star==$star->star){ echo 'selected="Selected"';} } ?>> <?php echo $star->star; ?></option>
										<?php
												}
											}
										?>	
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-4">
										...
										?>
											<option value="<?php echo $country->country_id; ?>" <?php if(isset($hotel_details->country)&& $hotel_details->country) { if($hotel_details->country==$country->country_id){ echo 'selected="Selected"';} } ?> >
								...
								<div class="form-group">
									...
									<input type="hidden" name="hotel_region1" value="<?php echo $hotel_details->hotel_region; ?>">
								</div>
								<div class="form-group">
									...
									<input type="hidden" name="hotel_city1" value="<?php echo $hotel_details->city; ?>">
								</div>
								<div class="form-group">
									...
									<input type="hidden" name="hotel_area1" value="<?php echo $hotel_details->hotel_area; ?>">
								</div>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="datepicker" name="start_date" placeholder="Start Date" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->start_date) && $hotel_details->start_date!=''){ echo $hotel_details->start_date;} ?>" ><span class="input-group-addon">Start Date</span>
										<span style="color:red;" id="error_lname"></span>
									  </div><br/>
									  <div class="input-group custom-input-group">
										<input id="datepicker1" name="end_date" placeholder="End Date" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->end_date) && $hotel_details->end_date!=''){ echo $hotel_details->end_date;} ?>"><span class="input-group-addon">End Date</span>
									  </div><br/>
								  </div>
								</div>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="box" name="box" placeholder="P.O.BOX" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->box) && $hotel_details->box!=''){ echo $hotel_details->box;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="postel" name="postel" placeholder="Postel Code" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->postel) && $hotel_details->postel!=''){ echo $hotel_details->postel;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="mobile_number" name="mobile_number" placeholder="Phone" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->mobile_number) && $hotel_details->mobile_number!=''){ echo $hotel_details->mobile_number;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="fax" name="fax" placeholder="Fax" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->fax) && $hotel_details->fax!=''){ echo $hotel_details->fax;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo $this->lang->line('Email'); ?></label>  
									<div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="email" name="email" placeholder="Email" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->main_email) && $hotel_details->main_email!=''){ echo $hotel_details->main_email;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput">Website</label>  
									<div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="Website" name="Website" placeholder="Website" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->website) && $hotel_details->website!=''){ echo $hotel_details->website;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="first_name" name="first_name" placeholder="First Name" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->contact_first_name) && $hotel_details->contact_first_name!=''){ echo $hotel_details->contact_first_name;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="last_name" name="last_name" placeholder="Last_Name" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->contact_last_name) && $hotel_details->contact_last_name!=''){ echo $hotel_details->contact_last_name;} ?>"><span class="input-group-addon">English</span>
										<span style="color:red;" id="error_lname"></span>
									  </div>
								  </div>
								</div>
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="Designation" name="Designation" placeholder="Designation" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->designation) && $hotel_details->designation!=''){ echo $hotel_details->designation;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="CNumber" name="CNumber" placeholder="Contact Number" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->contact_person_phone) && $hotel_details->contact_person_phone!=''){ echo $hotel_details->contact_person_phone;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="person_email" name="person_email" placeholder="Email" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->contact_person_email) && $hotel_details->contact_person_email!=''){ echo $hotel_details->contact_person_email;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="remail1" name="remail1" placeholder="Email" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->remail1) && $hotel_details->remail1!=''){ echo $hotel_details->remail1;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="remail2" name="remail2" placeholder="Email" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->remail2) && $hotel_details->remail2!=''){ echo $hotel_details->remail2;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="rfax" name="rfax" placeholder="Fax" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->rfax) && $hotel_details->rfax!=''){ echo $hotel_details->rfax;} ?>"><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="Telephone" name="Telephone" placeholder="Telephone" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->rphone) && $hotel_details->rphone!=''){ echo $hotel_details->rphone;} ?>"><span class="input-group-addon">English</span>
										<span style="color:red;" id="error_Telephone"></span>
									  </div>
								  </div>
								</div>
								<legend class="pd-lr-30-px">Person who signed the contract on behalf of the hotel</legend>	
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"> Name</label>  
									<div class="col-xs-12 col-md-4">
									   <div class="input-group custom-input-group">
											<input id="Name" name="Name" placeholder="Name" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->pname) && $hotel_details->pname!=''){ echo $hotel_details->pname;} ?>" ><span class="input-group-addon">English</span>
								...
								<div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="title" name="title" placeholder="title" class="form-control input-md" type="text" value="<?php if(isset($hotel_details->ptitle) && $hotel_details->ptitle!=''){ echo $hotel_details->ptitle;} ?>"><span class="input-group-addon">English</span>
