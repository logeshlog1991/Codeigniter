                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title"><?php echo $this->lang->line('template_list'); ?></h3></div>
                                    <div class="box-add" style="text-align:right;position:relative;right:12px;">
                            <button class="btn btn-primary" onClick="window.location='<?php echo WEB_URL;?>index/add_emailPage';"><?php echo $this->lang->line('add_emailPage'); ?></button>
                                </div><!-- /.box-header -->
                                        ...
                                        <tbody>
											<?php 
												...
												if(isset($email) && $email!=''){ 
													foreach($email as $page) {
											 ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo $page->email_name; ?></td>
                                                <td><?php echo $page->email_content; ?></td>
                                                <td><?php if($page->status==1) { echo 'Active'; } else { echo 'InActive'; } ?></td>
                                                <td><?php if($page->status!=1){ ?> <a href="<?php echo WEB_URL;?>index/Active_emailpage/<?php echo $page->m_no;?>"><?php echo $this->lang->line('Active'); ?></a><?php }else{ ?><a href="<?php echo WEB_URL;?>index/Inactive_emailpage/<?php echo $page->m_no;?>"><?php echo $this->lang->line('InActive'); ?></a> <?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp;<?php if($page->status!="") { ?> <a href="<?php echo WEB_URL;?>index/edit_emailpage/<?php echo $page->m_no;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>index/delete_emailpage/<?php echo $page->m_no;?>"><?php echo $this->lang->line('Delete'); ?></a><?php } ?> </td>
                                            </tr>
											<?php 
													$i++;
													} 
