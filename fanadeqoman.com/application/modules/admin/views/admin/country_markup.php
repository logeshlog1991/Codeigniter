        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									...
									<li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);"><?php echo $this->lang->line('Country_Markup'); ?></a></li>
									...
									<li style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="<?php echo WEB_URL;?>index/Star_markup">Markup as per Hotel Rating</a></li>
						      </div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
				<div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>index/update_country_markup" id="formid" method="post" onsubmit="return update_country_markup()">
								<fieldset><br/><br/><br/>
										<!-- Form Name -->
										<?php 
											if(isset($id) && $id!=''){
										...
										<div class="form-group">
										  ...
										  <div class="col-xs-12 col-md-4">
												<select id="country" name="country" class="form-control input-md" onchange="update_country()">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<?php 
												$i=1;
												if(isset($country_markup) && $country_markup!=''){ 
													foreach($country_markup as $value){ 
											?>
											<tr>
												<td><?php echo $i;?></td>
												<td><?php echo $value->country_name; ?></td>
												<td><?php echo $value->country_markup; ?></td>
												<td><?php if($value->status==1){ echo "Active";}else{ echo "InActive"; } ?></td>
												<td><?php if($value->status!=1){ ?> <a href="<?php echo WEB_URL;?>index/Active_country_markup/<?php echo $value->country_markupid; ?>"><?php echo $this->lang->line('Active'); ?></a><?php }else{ ?><a href="<?php echo WEB_URL;?>index/InActive_country_markup/<?php echo $value->country_markupid; ?>"><?php echo $this->lang->line('InActive'); ?></a><?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>index/delete_country_markup/<?php echo $value->country_markupid;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
											</tr>
											<?php 
													$i++;
													}
