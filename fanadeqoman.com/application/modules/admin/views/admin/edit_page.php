											  ...
											  <!-- Form Name -->
												 <div class="form-group">
												  ...
												  <div class="col-xs-12 col-md-4">
													  <div class="input-group custom-input-group">
														<input type="text" name="page_name" placeholder="page name" id="page_name" class="form-control input-md" value="<?php echo $page->page_name; ?>"><span class="input-group-addon">English</span>
														<span style="color:red;" id="error_page"></span>
														</div><br/>
													   <div class="input-group custom-input-group">
														 <input type="text" name="page_nameA" placeholder="page name" id="page_nameA" class="form-control input-md" value="<?php echo $page->page_nameA; ?>" ><span class="input-group-addon">Arabic</span>
												...
												<div class="form-group">
												  ...
												  <div class="col-xs-12 col-md-6">
														<textarea id="content" name="editor1" placeholder="Page Content" class="form-control input-md" ><?php echo $page->page_content; ?></textarea>
												...
												<div class="form-group">
												  ...
												  <div class="col-xs-12 col-md-6">
														<textarea id="page_contentA" name="editor2" placeholder="Page Content" class="form-control input-md" ><?php echo $page->page_contentA; ?></textarea>
														<span style="color:red;" id="error_pageContentA"></span>
												  </div>
												</div>
												<input type="hidden" id="base_url" name="base_url" value="<?php echo WEB_URL;?>">
												<input type="hidden" id="page_id" name="page_id" value="<?php echo $page->p_no; ?>">
												<div class="form-group">
...
<script>
	function add_Page()
	{
		...
		if(flag==false || flag1==false || flag2==false || flag3==false){
			...
			$.ajax({
				 url: $('#base_url').val()+"index/update_page_ad/"+$('#page_id').val(),
				 type: 'post',
