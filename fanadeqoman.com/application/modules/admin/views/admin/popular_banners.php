			...
			$(document).ready(function(){
				$(document).on("click",".delete-img",function(){
					...
					if(img_db!='' && imageId!=''){
						...
						$.ajax({
							 url: base_url+"index/delete_popularImg",
							 type: 'post',
            ...
            <aside class="right-side">
                ...
                <section class="content">
                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="#tab_1" data-toggle="tab">Popular Banners</a></li>
                            </div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
                    <div class="row">
                 ...
                 <div class="box box-primary">
                           <form class="form-horizontal add_hotel_form" enctype="multipart/form-data" action="<?php echo WEB_URL;?>index/edit_popularBanners/<?php echo $banners[0]->s_no; ?>" id="formid" method="post">
                               <fieldset><br><br/>
