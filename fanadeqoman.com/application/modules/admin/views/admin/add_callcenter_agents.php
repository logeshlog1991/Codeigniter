                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
									<li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);"> <?php echo $this->lang->line('Add_CallCenter_Agents'); ?></a></li>
							    </div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
								...
								<div class="col-xs-12">
									<div class="box">
										...
										<div class="box-body table-responsive">
											<form enctype="multipart/form-data" class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>index/callcenter_agents_ad" id="formid" method="post" onsubmit="return call_agents()">
											  <!-- Form Name -->
												<div class="form-group">
												  <label class="col-xs-12 col-md-3 control-label" for="textinput"><?php echo $this->lang->line('Email'); ?></label>  
												  <div class="col-xs-12 col-md-4">
														<input id="email" name="email" placeholder="Email" class="form-control input-md" type="text" value="">
												...
												<div class="form-group">
												  ...
												  <div class="col-xs-12 col-md-4">
														<input id="name" name="name" placeholder="Name" class="form-control input-md" type="text" value="">
												...
												<div class="form-group">
												  ...
												  <div class="col-xs-12 col-md-4">
														<input id="contact_number" name="contact_number" placeholder="Contact Number" class="form-control input-md" type="text" value="">
												...
												<div class="form-group">
												  ...
												  <div class="col-xs-12 col-md-4">
														<select id="paymnet_currency" name="paymnet_currency" class="form-control input-md">
															...
															?>
																<option value="<?php echo $value->value; ?>"><?php echo $value->currency;?></option>
															<?php 
																	}	 
																}
															?>
												...
												<div class="form-group">
												  ...
												  <div class="col-xs-12 col-md-4">
														<input id="bank_state" name="bank_state" placeholder="Bank State/ Province" class="form-control input-md" type="text" value="">
												...
												<div class="form-group">
												  ...
												  <div class="col-xs-12 col-md-4">
														...
														<span style="color:red;" id="error_logo"></span>
												  </div>
												</div>
												<div class="form-group">
