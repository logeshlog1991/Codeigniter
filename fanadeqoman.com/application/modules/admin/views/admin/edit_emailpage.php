								...
								<div class="col-xs-12">
									<div class="box">
										...
										<div class="box-body table-responsive">
											<form enctype="multipart/form-data" class="form-horizontal add_hotel_form" id="formid" method="post" action="<?php echo WEB_URL; ?>index/edit_emailPage_ad/<?php echo $page->m_no; ?>">
											  <!-- Form Name -->
												 <div class="form-group">
												  <label class="col-xs-12 col-md-3 control-label" for="textinput">Page Name</label>  
												  <div class="col-xs-12 col-md-4">
													  <div class="input-group custom-input-group">
														<input type="text" name="page_name" placeholder="page name" id="page_name" class="form-control input-md" value="<?php if(isset($page->email_name) && $page->email_name!=''){ echo $page->email_name; }  ?>"><span class="input-group-addon">English</span>
														<span style="color:red;" id="error_page"></span>
														</div><br/>
													   <div class="input-group custom-input-group">
														 <input type="text" name="page_nameA" placeholder="page name" id="page_nameA" class="form-control input-md" value="<?php if(isset($page->email_nameA) && $page->email_nameA!=''){ echo $page->email_nameA; } ?>"><span class="input-group-addon">Arabic</span>
												...
												<div class="form-group">
												  ...
												  <div class="col-xs-12 col-md-6">
														<textarea id="content" name="editor1" placeholder="Page Content" class="form-control input-md" ><?php if(isset($page->email_content) && $page->email_content!=''){ echo $page->email_content; }  ?></textarea>
												...
												<div class="form-group">
												  ...
												  <div class="col-xs-12 col-md-6">
														<textarea id="page_contentA" name="editor2" placeholder="Page Content" class="form-control input-md" ><?php if(isset($page->email_content) && $page->email_content!=''){ echo $page->email_contentA; }  ?></textarea>
