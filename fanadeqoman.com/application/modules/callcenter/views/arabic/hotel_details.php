				...
				if($('#check_value'+id).val()==id){
					if(hotel_id!=''){
						$.ajax({
							 ...
							 type: 'post',
							 data:  {'hotel_id':hotel_id,'check_in':check_in,'check_out':check_out,'rooms':rooms,'sup_rate_id':$('#sup_rate_id').val()},
...
<body>
   <div class="wrapper">
		...
		<!-- modify search-->
					...
					<div class="row">
						<div class="col-lg-3">
							...
							<div class="col-lg-2 modpad">
								<div class="input-group">
									<span class="input-group-addon border-right no-border-left">
			...
			<div class="container">
					<div class="well">
							<h3 class="orangetxt">
								<b><?php echo $hotel_info->hotel_nameA;?></b>
							</h3>
							<p>
								<?php 
 ...
 <div id="slider1_container" style="position: relative; width: 720px;
        height: 350px; overflow: hidden; margin-bottom:10px;">
        <!-- Loading Screen -->
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 720px; height: 350px;
            overflow: hidden;">
				<?php 
 ...
 <!-- slider area-->
		...
		<div class="container">
			<div class="well well-sm well-blue">
				<?php echo $this->lang->line('PROPERTY_OVERVIEW'); ?>
			</div>
			<div class="well">
				<?php echo $hotel_info->hotel_descA; ?>
			</div>
		</div>
		...
		<div class="container">
			<div class="well well-sm well-blue">
				<?php echo $this->lang->line('PROPERTY_FACILITIES'); ?>
			</div>
			<div class="well">
				<?php
		...
		<div class="well well-sm well-blue"><?php echo $this->lang->line('ROOMS'); ?> &amp;<?php echo $this->lang->line('RATES'); ?></div>
		 <?php 
				$res=$this->Hotel_Model->get_category2($hotel_info->sup_hotel_id); 
				$A='';$cate='';$type='';
					if($res!='') {
						for($i=0;$i<count($res);$i++) {	
							$cate=$res[$i]->hotel_room_typeA;
							$type=$res[$i]->capacity_titleA;		
		   ?>
		   <div class="well">     
				<div class="row info">
				  <div class="col-sm-4">
					  <?php //$cate=$this->Hotel_Model->get_catedetails($res[$i]->category_type); ?>
					  <h4><?php echo $res[$i]->hotel_room_typeA; ?>-<?php echo $res[$i]->capacity_titleA; ?></h4>
						<!--<p><a href="#"><?php echo $this->lang->line('Room_Details'); ?> </a></p>-->
				  </div>
				  <div class="col-sm-2">
					 <?php  
						$var3=unserialize($res[$i]->hotel_room_services); 
						if($var3!='') {
				  ...
				  <div class="col-sm-4 ">
					 <div class="row">
						 <?php  
							$rate=$this->Hotel_Model->get_rate($res[$i]->sup_rate_tactics_id);
						 ?>
						 <span class="rate">
								<?php 
									...
									$final_rate=($cal_tax->callcenter_markup/100)*$rate+$rate;	
					 ...
					 <div class="col-sm-6 mt20"><span><?php echo $this->lang->line('nit'); ?> </span></div>
				  </div>
				  <div class="col-sm-2 mt15">
						<form id="formid<?php echo $i; ?>" action="<?php echo WEB_URL;?>hotel/pre_booking" method="post">
						  ...
						  <input type="hidden" id="room_type" name="room_type" value="<?php echo $type; ?>" />
						  <input type="hidden" id="room_cost" name="room_cost" value="<?php echo round($final_rate); ?>" />
						  <input type="hidden" id="room_name" name="room_name" value="<?php echo $cate; ?>" />
						  ...
						  <input type="submit" class="btn btn-blue btn-small wid100 pull-right" value="11<?php echo $this->lang->line('book_now'); ?>" onclick="check_avilabless('<?php echo $i; ?>')" />
						</form>
				  </div>
			   </div>
			</div>
		...
		<div class="container">
		   <div class="well well-sm well-blue"><?php echo $this->lang->line('LOCATION_MAP'); ?></div>
				...
				<div class="well" id="map_canvas" style="height:400px;" >    
		   </div>
	   </div>
	   <!-- property FACILITIES end-->
	   <div class="container">
	  ...
	  <div class="container">
		...
		<div class="row">
			...
			?>
			<a href="<?php echo WEB_URL;?>hotel/hotel_details/<?php echo $hotels[$i]->sup_hotel_id;?>/<?php echo $hotels[$i]->sup_rate_tactics_id; ?>">
				<div class="col-lg-3">
					<div class="well pad8">
						<img src="<?php echo WEB_DIR;?>public/hotel_img/<?php echo $hotels[$i]->main_image; ?>" class="img-responsive" >
						<h5 class=" hotelhead " > <?php echo $hotels[$i]->hotel_nameA; ?></h5>
						...
						<h6>
							...
							<span class="hotelrate1">
								<?php 
									$agent_id=$this->session->userdata('user_id');   
									$cal_tax=$this->Hotel_Model->get_agentinfo($agent_id);
									$final_rate1=($cal_tax->callcenter_markup/100)*$hotels[$i]->sell_price+$hotels[$i]->sell_price;	
							...
							<span class="durationinfo1"><?php echo $this->lang->line('nit'); ?></span>
						</h6>
					</div>
				</div><!-- col-3-->
			</a>
