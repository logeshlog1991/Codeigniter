                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Hotel lists</h3></div>
                                    <div class="box-add" style="text-align:right;position:relative;right:12px;">
                            <button class="btn btn-primary" onClick="window.location='<?php echo WEB_URL;?>hotel/add_hotel';">Add Hotel</button>
                                </div><!-- /.box-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $hotel->city_country_name; ?></td>
                                                <td><?php echo $hotel->main_first_name; ?></td>
                                                <td><?php echo $hotel->main_email; ?></td>
                                                <td><?php if($hotel->status==1) { echo 'Active'; } else { echo 'InActive'; } ?></td>
                                                <td><?php if($hotel->status!=1){ ?> <a href="<?php echo WEB_URL;?>hotel/Active_hotel/<?php echo $hotel->sup_hotel_id;?>">Active</a><?php }else{ ?><a href="<?php echo WEB_URL;?>hotel/Inactive_hotel/<?php echo $hotel->sup_hotel_id;?>">InActive</a><?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo WEB_URL;?>hotel/edit_hotel/<?php echo $hotel->sup_hotel_id;?>">Edit</a>&nbsp;&nbsp;/&nbsp;&nbsp;<a onclick="return confirm('Are you sure want to delete...?')" href="<?php echo WEB_URL;?>hotel/delete_hotel/<?php echo $hotel->sup_hotel_id;?>">Delete</a></td>
                                            </tr>
											<?php 
													$i++;
													} 
