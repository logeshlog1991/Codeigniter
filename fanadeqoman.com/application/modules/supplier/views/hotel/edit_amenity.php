                        ...
                        <div class="col-md-6" style="width:100% !important;">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active" style="width: 24% !important;font-size:16px;font-family:bold:helica;"><a href="#tab_1" data-toggle="tab"> Amenity List</a></li>
                             </div><!-- nav-tabs-custom -->
                        </div><!-- /.col -->
                    </div> <!-- /.row -->
                 ...
                 <div class="box box-primary">
                               ...
                               <fieldset><br/><br/>
								<div class="form-group">
								  <label class="col-xs-12 col-md-3 control-label" for="textinput"> Amenity</label>  
								  <div class="col-xs-12 col-md-4">
										<input id="amenity" name="amenity" placeholder=" Amenity" class="form-control input-md" type="text" value="<?php if(isset($amenity_name->amenity_name) && $amenity_name->amenity_name!=''){ echo $amenity_name->amenity_name; }?>">
