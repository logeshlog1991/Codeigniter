                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
									...
									<button class="btn btn-primary" onClick="window.location='<?php echo WEB_URL;?>hotel/add_roompolicy';"><?php echo $this->lang->line('Add_RoomPolicy'); ?></button>
                                </div><!-- /.box-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo $this->lang->line('Departure_Time'); ?></th>
                                                <th><?php echo $this->lang->line('Action'); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
											<?php $i=1;
												if(isset($room_policy) && $room_policy!=''){ 
													foreach($room_policy as $policy) {
											 ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo $policy->hotel_name; ?></td>
                                                <td><?php echo $policy->arrivaltime_from; ?></td>
                                                <td><?php echo $policy->departtime_before; ?></td>
												<td><a href="<?php echo WEB_URL;?>hotel/edit_roomplicy/<?php echo $policy->sup_apart_houserules_id;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a onclick="return confirm('Are you sure want to delete...?');"  href="<?php echo WEB_URL;?>hotel/delete_roomplicy/<?php echo $policy->sup_apart_houserules_id;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
                                            </tr>
											<?php 
													$i++;
													} 
