...
<html>
    ...
    <body class="skin-blue">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                   <li style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);" onclick="return room_list()">Room List</a></li>
									...
									<li class="active" style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);"><?php echo $this->lang->line('Room_Count'); ?> </a></li>
                 ...
                 <div class="box box-primary">
								<div class="box-header" style="height:50px">
									<table style="text-align:right;position:relative;right:-872px;">
										<tr> 
										<!--<td colspan="3" class="btn btn-primary" style="text-align:right;"><a href="<?php echo WEB_URL;?>hotel/roomcount_list"><b>Back</b></a></td>-->
										</tr>
                               ...
                               <!-- form start -->
                               <form class="form-horizontal add_hotel_form" action="<?php echo WEB_URL;?>hotel/roomcount_ad" id="formid" method="post" onsubmit="return roomcount_ad()">
                               <fieldset><br/><br/>
        ...
        <!-- Admin for demo purposes --><script>
		function room_list()
		{
			alert("Please Add No of Rooms");
		}
