                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo WEB_URL;?>hotel/edit_category/<?php echo $category->sup_hotel_room_type_id;?>"><?php echo $this->lang->line('Edit'); ?></a>&nbsp;&nbsp;/&nbsp;&nbsp;<a onclick="return confirm('Are you sure want to delete...?')" href="<?php echo WEB_URL;?>hotel/delete_category/<?php echo $category->sup_hotel_room_type_id;?>"><?php echo $this->lang->line('Delete'); ?></a></td>
                                            </tr>
											<?php 
													$i++;
													} 
