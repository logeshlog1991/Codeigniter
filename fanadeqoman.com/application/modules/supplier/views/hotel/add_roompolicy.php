...
<html>
    ...
    <body class="skin-blue">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                  <li style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);" onclick="return room_list()">Room List</a></li>
									...
									<li class="active" style="width: 16% !important;font-size:16px;font-family:bold:helica;"><a href="javascript:void(0);"><?php echo $this->lang->line('Room_Policy'); ?> </a></li>
							    ...
							    <div class="form-group">
								  ...
								  <div class="col-xs-12 col-md-4">
									  <div class="input-group custom-input-group">
										<input id="sproom_policies" name="sproom_policies" placeholder="Special Room Policies" class="form-control input-md" type="text"><span class="input-group-addon">English</span>
										<span style="color:red;" id="error_sproom_policies"></span>
								   	  </div><br/>
								   	  <div class="input-group custom-input-group">
										<input id="sproom_policiesA" name="sproom_policiesA" placeholder="Special Room Policies" class="form-control input-md" type="text"><span class="input-group-addon">Arabic</span>
									  </div><br/>
								  </div>
								</div>
								<div class="form-group">
        ...
        <!-- page script -->
        <!-- validation  script -->
        <script src="<?php echo WEB_DIR;?>js/custom2.js" type="text/javascript"></script>
