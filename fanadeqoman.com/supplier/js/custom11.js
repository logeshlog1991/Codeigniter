	...
	function add_hotel_validation(){
		...
		if(flag==false || flag1==false || flag2==false || flag3==false || flag4==false || flag5==false || flag6==false || flag7==false || flag8==false || flag9==false || flag11==false || flag12==false){
			return false;
		}
	}
			...
			$.ajax({
					 ...
					 success: function(output) {
						 if(output=='sucess'){
							...
							$("#error_hotelname").append('<span style="color:red;" id="error_hotelnames">Invalid Password</span>');return false;
						 }
					}
				});
		}
